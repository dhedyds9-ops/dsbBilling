...
class AssignDeviceJob implements ShouldQueue
{
    ...
    public function handle(
        ...
        $instance->markAssigned();
        $repository->save($instance);

        $dispatcher->dispatch(new \Src\Domain\Provisioning\Events\DeviceAssignedEvent($instanceId));
    }
