...
use App\Services\Workforce\TroubleshootingTaskService;
...
class CreateTroubleshootingTaskJob implements ShouldQueue {
    ...
    public function handle(TroubleshootingTaskService $service): void {
        $service->createTroubleshootingTask(
