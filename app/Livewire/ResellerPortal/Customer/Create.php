...
class Create extends AdminComponent
{
    ...
    public function save()
    {
        ...
        try {
            ...
            'username'           => 'required|string|unique:pppoe_users,username',
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('Reseller Customer create failed: ' . $e->getMessage());
