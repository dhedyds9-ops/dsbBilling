...
class Edit extends AdminComponent
{
    ...
    public function mount($id = null)
    {
        ...
        $this->breadcrumbs = [
            ...
            ['label' => $this->pppoeUser->username, 'url' => route('aaa.pppoe-users.show', $this->pppoeUserId)],
            ['label' => 'Edit'],
        ];
    }
    ...
    public function save()
    {
        ...
        return redirect()->route('aaa.pppoe-users.show', $this->pppoeUserId);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.aaa.pppoe-user.edit', compact('customerServices', 'serviceProfiles'));
    }
}
