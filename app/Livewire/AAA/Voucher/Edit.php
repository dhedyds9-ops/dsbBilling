...
class Edit extends AdminComponent
{
    ...
    public function mount($id = null)
    {
        ...
        $this->breadcrumbs = [
            ...
            ['label' => $this->voucher->code, 'url' => route('aaa.vouchers.show', $this->voucherId)],
            ['label' => 'Edit'],
        ];
    }
    ...
    public function save()
    {
        ...
        return redirect()->route('aaa.vouchers.show', $this->voucherId);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.aaa.voucher.edit', compact('voucherPools', 'hotspotUsers'));
    }
}
