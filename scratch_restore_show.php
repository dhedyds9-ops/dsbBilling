...
<div>
    ...
    <div class="no-print mb-4 flex justify-between items-center px-4 md:px-8">
        <a href="{{ route('billing.invoices.index') }}" class="px-4 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg hover:bg-slate-50 flex items-center gap-2 transition-colors">
    ...
    <div class="bg-slate-100 dark:bg-slate-900 p-4 md:p-8 min-h-screen flex justify-center">
