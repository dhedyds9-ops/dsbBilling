...
$thSearch = '<th class="px-6 py-3 text-left font-semibold">Pelanggan / No Tagihan</th>';
$thReplace = '<th class="px-6 py-3 text-left font-semibold">Pelanggan / No Tagihan</th>' . "\n" . '                        <th class="px-6 py-3 text-left font-semibold">Profil Paket</th>';
