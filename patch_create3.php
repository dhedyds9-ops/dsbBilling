...
// In Section 4: Afiliasi, we just replace the reseller_id select with a hidden input or just nothing.
// Let's just find the div containing wire:model="reseller_id"
$search = <<<EOT
                        <div>
...
echo "Restored and correctly patched create.blade.php\n";
?>
