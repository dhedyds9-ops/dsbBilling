<div class="max-w-7xl mx-auto p-3">
    ...
    <div class="flex items-center gap-4 mb-3">
        <a href="{{ route('isp.routers.show', $router->id) }}" class="p-2 text-slate-500 hover:text-slate-700 rounded-lg hover:bg-slate-100">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">{{ $router->name }}</p>
        </div>
    </div>
    ...
    <x-base.card>
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="flex items-center justify-end gap-4 pt-4 border-t border-slate-200">
                <a href="{{ route('isp.routers.show', $router->id) }}" class="px-6 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors">
                    Batal
                </a>
