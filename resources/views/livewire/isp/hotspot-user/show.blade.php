<div class="space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('isp.hotspot-users.edit', $hotspotUser->id) }}" class="px-4 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors">
                Edit
            </a>
        </div>
    </div>
