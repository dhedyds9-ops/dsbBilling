<div class="space-y-6">
    <div class="flex items-center gap-4">
        <a href="{{ route('isp.hotspot-users.index') }}" class="p-2 text-slate-500 hover:text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-100 dark:bg-slate-800">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('isp.hotspot-users.edit', $hotspotUser->id) }}" class="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-50 dark:bg-slate-900/50 transition-colors">
                Edit
            </a>
        </div>
    </div>
