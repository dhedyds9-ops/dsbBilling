    ...
    <div class="xl:col-span-2 space-y-4">
      ...
      <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
        ...
        <div class="p-4 space-y-4">
          @if ($errors->has('genieAcsForm'))
            <div class="p-3 text-xs text-rose-700 bg-rose-50 dark:bg-rose-900/20 dark:text-rose-300 border-l-4 border-rose-500">{{ $errors->first('genieAcsForm') }}</div>
          @endif
