<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100">Edit Template Provisioning</h1>
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Edit template provisioning</p>
        </div>
    </div>
