    ...
    <x-base.card>
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex justify-end gap-4 pt-4 border-t border-slate-200">
                <a href="{{ route('acs.devices.index') }}" class="px-4 py-2 text-sm font-medium text-slate-700 bg-slate-100 rounded-lg hover:bg-slate-200 transition-colors">Kembali</a>
