    ...
    <div class="p-4 border-b border-gray-200">
        ...
        <div class="grid grid-cols-2 gap-2">
            <button 
                ...
                class="px-3 py-2 text-xs font-medium rounded-lg transition-colors {{ $activeLayer === 'capacity' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}"
            >
                Capacity
            </button>
            <button 
                wire:click="$set('activeLayer', 'traffic')"
                class="px-3 py-2 text-xs font-medium rounded-lg transition-colors {{ $activeLayer === 'traffic' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}"
            >
                Traffic
            </button>
            <button 
                wire:click="$set('activeLayer', 'customers')"
                class="px-3 py-2 text-xs font-medium rounded-lg transition-colors {{ $activeLayer === 'customers' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}"
            >
                Customers
            </button>
            <button 
                wire:click="$set('activeLayer', 'density')"
                class="px-3 py-2 text-xs font-medium rounded-lg transition-colors {{ $activeLayer === 'density' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600 hover:bg-gray-200' }}"
            >
                Density
            </button>
        </div>
    ...
    <div class="p-4 border-b border-gray-200 space-y-4">
        ...
        <div>
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-xs font-medium text-gray-700">{{ $radiusKm }}</span>
            </div>
            <input 
                type="range" 
                min="1" 
        ...
        <div>
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-xs font-medium text-gray-700">{{ $gridSize }}</span>
            </div>
            <input 
                type="range" 
                min="0.1" 
