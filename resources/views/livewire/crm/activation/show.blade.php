<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex-1">
            <h1 class="text-2xl font-bold text-slate-900">{{ $activation->customer_name }}</h1>
            <div class="flex items-center gap-2 mt-1">
                ...
                <span class="text-sm text-slate-500">{{ $activation->activation_date?->format('d/m/Y') }}</span>
            </div>
        </div>
        <div class="flex items-center gap-2">
            <a href="{{ route('crm.activations.edit', $activation->id) }}" class="px-4 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors">
                Edit
            </a>
        </div>
    </div>
