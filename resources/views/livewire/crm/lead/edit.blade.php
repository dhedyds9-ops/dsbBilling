    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/20 flex items-center justify-between">
            ...
            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wide
                @if($status === 'new') bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-400
                @elseif($status === 'contacted') bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-400
                @elseif($status === 'qualified') bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-400
                @elseif($status === 'converted') bg-emerald-100 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-400
