<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">Kelola pengaturan aplikasi WiFiNan ERP Anda.</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-soft">
            ...
            <div class="p-6 space-y-4">
                <div class="space-y-2">
                    ...
                    <input type="text" value="{{ config('app.name') }}" readonly class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm">
                </div>
                <div class="space-y-2">
                    <label class="block text-sm font-medium text-slate-700">URL Aplikasi</label>
                    <input type="text" value="{{ config('app.url') }}" readonly class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm">
                </div>
                <div class="space-y-2">
                    <label class="block text-sm font-medium text-slate-700">Zona Waktu</label>
                    <input type="text" value="{{ config('app.timezone') }}" readonly class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm">
                </div>
            </div>
        </div>
