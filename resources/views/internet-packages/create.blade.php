            ...
            <form method="POST" action="{{ route('internet-packages.store') }}">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror dark:bg-slate-900 dark:text-slate-100" id="price" name="price" value="{{ old('price') }}" required>
                        @error('price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('bandwidth_download') is-invalid @enderror dark:bg-slate-900 dark:text-slate-100" id="bandwidth_download" name="bandwidth_download" value="{{ old('bandwidth_download') }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('bandwidth_upload') is-invalid @enderror dark:bg-slate-900 dark:text-slate-100" id="bandwidth_upload" name="bandwidth_upload" value="{{ old('bandwidth_upload') }}" required>
