...
<div class="p-4 sm:p-6 min-h-[calc(100vh-4rem)] flex flex-col items-center pb-24" x-data="speedTestData()">
...
echo "Fixed Alpine JS structure for speed test.\n";
?>
