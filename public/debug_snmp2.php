...
$cmd3 = 'snmpwalk -O n -v 2c -c MstoreRead2026 192.168.99.1 .1.3.6.1.4.1.50224.3.2.1.1.6 2>&1';
echo "Test HSGQ PON Ports Status:\n";
echo shell_exec($cmd3) . "\n\n";

$cmd4 = 'snmpwalk -O n -v 2c -c MstoreRead2026 192.168.99.1 .1.3.6.1.4.1.50224.3.12.2.1.15 2>&1';
echo "Test HSGQ ONU Serials:\n";
echo shell_exec($cmd4) . "\n\n";

$cmd5 = 'snmpwalk -O n -v 2c -c MstoreRead2026 192.168.99.1 .1.3.6.1.4.1.50224.3.12.2.1.22 2>&1';
