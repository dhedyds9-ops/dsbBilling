...
// Extract everything BEFORE @elseif($activeTab === 'pppoe')
$posPppoe = strpos($content, "@elseif(\ === 'pppoe')");
$beforePppoe = substr($content, 0, $posPppoe);

// Extract everything AFTER @elseif($activeTab === 'logs')
$posLogs = strpos($content, "@elseif(\ === 'logs')");
                            ...
                            <tbody class="bg-white dark:bg-slate-900 divide-y divide-slate-200 dark:divide-slate-800 font-mono text-[13px]">
                                @forelse(\ ?? [] as \)
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                        ...
                                        <td class="px-6 py-3 text-slate-500 dark:text-slate-400">{{ \['interface'] ?? '-' }}</td>
                                        <td class="px-6 py-3 text-slate-500 dark:text-slate-400">{{ \['default-profile'] ?? '-' }}</td>
                                    </tr>
                                @empty
                            ...
                            <tbody class="bg-white dark:bg-slate-900 divide-y divide-slate-200 dark:divide-slate-800 font-mono text-[13px]">
                                @forelse(\ ?? [] as \C:\Users\Lenovo\OneDrive\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1)
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                        ...
                                        <td class="px-6 py-3 text-slate-500 dark:text-slate-400">{{ \C:\Users\Lenovo\OneDrive\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1['local-address'] ?? '-' }}</td>
                                        <td class="px-6 py-3 text-slate-500 dark:text-slate-400">{{ \C:\Users\Lenovo\OneDrive\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1['remote-address'] ?? '-' }}</td>
                                        <td class="px-6 py-3 text-slate-500 dark:text-slate-400">{{ \C:\Users\Lenovo\OneDrive\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1['rate-limit'] ?? '-' }}</td>
                                    </tr>
                                @empty
                                    ...
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span class="text-sm font-bold text-slate-900 dark:text-slate-100">{{ \['name'] ?? '-' }}</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400 font-mono">{{ \['address'] ?? '-' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400 font-mono">{{ \['caller-id'] ?? '-' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400">{{ \['uptime'] ?? '-' }}</td>
                                    </tr>
                                @empty
                                    <tr>
                            ...
                            <tbody class="bg-white dark:bg-slate-900 divide-y divide-slate-200 dark:divide-slate-800 font-mono text-[13px]">
                                @forelse(\ ?? [] as \)
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                        ...
                                        <td class="px-6 py-3 text-slate-500 dark:text-slate-400">{{ \['interface'] ?? '-' }}</td>
                                        <td class="px-6 py-3 text-slate-500 dark:text-slate-400">{{ \['profile'] ?? '-' }}</td>
                                    </tr>
                                @empty
                        ...
                        <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                            ...
                            <tbody class="bg-white dark:bg-slate-900 divide-y divide-slate-200 dark:divide-slate-800 font-mono text-[13px]">
                                @forelse(\ ?? [] as \C:\Users\Lenovo\OneDrive\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1)
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                        <td class="px-6 py-3 text-slate-900 dark:text-slate-100 font-bold">{{ \C:\Users\Lenovo\OneDrive\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1['name'] ?? '-' }}</td>
                                        <td class="px-6 py-3 text-slate-500 dark:text-slate-400">{{ \C:\Users\Lenovo\OneDrive\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1['shared-users'] ?? '-' }}</td>
                                        <td class="px-6 py-3 text-slate-500 dark:text-slate-400">{{ \C:\Users\Lenovo\OneDrive\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1['rate-limit'] ?? '-' }}</td>
                                    </tr>
                                @empty
                                    ...
                                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span class="text-sm font-bold text-slate-900 dark:text-slate-100">{{ \['user'] ?? \['name'] ?? '-' }}</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400 font-mono">{{ \['address'] ?? \['ip'] ?? '-' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400 font-mono">{{ \['mac-address'] ?? \['mac'] ?? '-' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-500 dark:text-slate-400">{{ \['uptime'] ?? '-' }}</td>
                                    </tr>
                                @empty
                                    <tr>
...
$newContent = $beforePppoe . $newPppAndHotspot . "\n" . $afterLogs;
