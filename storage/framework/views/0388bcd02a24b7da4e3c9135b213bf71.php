<div class="space-y-6 pb-10" wire:poll.30s="loadData">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <div class="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium border border-slate-200 dark:border-slate-700 flex items-center gap-2"
                ...
                <span x-text="time"><?php echo e(date('l, d F Y H:i')); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-wrap items-center gap-2 p-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm">
        ...
        <a href="<?php echo e(route('crm.customers.index')); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-800/50 text-indigo-700 dark:text-indigo-300 rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer hover:shadow-sm hover:-translate-y-px">
            <span class="material-symbols-outlined notranslate" translate="no" style="font-size:15px">person_add</span>
            Pelanggan
        </a>
        <a href="<?php echo e(route('isp.pppoe-users.index')); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-sky-50 hover:bg-sky-100 dark:bg-sky-900/30 dark:hover:bg-sky-800/50 text-sky-700 dark:text-sky-300 rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer hover:shadow-sm hover:-translate-y-px">
            <span class="material-symbols-outlined notranslate" translate="no" style="font-size:15px">router</span>
            PPPoE
        </a>
        <a href="<?php echo e(route('isp.hotspot-users.index')); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-orange-50 hover:bg-orange-100 dark:bg-orange-900/30 dark:hover:bg-orange-800/50 text-orange-700 dark:text-orange-300 rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer hover:shadow-sm hover:-translate-y-px">
            <span class="material-symbols-outlined notranslate" translate="no" style="font-size:15px">wifi_tethering</span>
            Hotspot
        </a>
        <a href="<?php echo e(route('billing.invoices.create')); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-900/30 dark:hover:bg-emerald-800/50 text-emerald-700 dark:text-emerald-300 rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer hover:shadow-sm hover:-translate-y-px">
            <span class="material-symbols-outlined notranslate" translate="no" style="font-size:15px">receipt_long</span>
            Buat Tagihan
        </a>
        <a href="<?php echo e(route('isp.routers.index')); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-purple-50 hover:bg-purple-100 dark:bg-purple-900/30 dark:hover:bg-purple-800/50 text-purple-700 dark:text-purple-300 rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer hover:shadow-sm hover:-translate-y-px">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div class="relative overflow-x-auto rounded-xl border border-indigo-200 dark:border-indigo-800/60 shadow-md bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-indigo-700 dark:text-indigo-300 mb-3"><?php echo e(number_format($kpi['customer']['total'] ?? 0)); ?></div>
                <div class="grid grid-cols-3 gap-1.5">
                    <a href="<?php echo e(route('crm.customers.index')); ?>" class="rounded-lg px-2 py-1.5 bg-emerald-100 dark:bg-emerald-900/50 hover:bg-emerald-200 dark:hover:bg-emerald-800/70 transition-colors text-center">
                        <span class="block text-emerald-700 dark:text-emerald-400 font-semibold text-xs">Aktif</span>
                        <span class="text-emerald-800 dark:text-emerald-300 font-black text-sm"><?php echo e($kpi['customer']['active'] ?? 0); ?></span>
                    </a>
                    <a href="<?php echo e(route('crm.customers.index')); ?>" class="rounded-lg px-2 py-1.5 bg-red-100 dark:bg-red-900/50 hover:bg-red-200 dark:hover:bg-red-800/70 transition-colors text-center">
                        <span class="block text-red-600 dark:text-red-400 font-semibold text-xs">Suspend</span>
                        <span class="text-red-700 dark:text-red-300 font-black text-sm"><?php echo e($kpi['customer']['suspend'] ?? 0); ?></span>
                    </a>
                    <div class="rounded-lg px-2 py-1.5 bg-blue-100 dark:bg-blue-900/50 text-center">
                        ...
                        <span class="text-blue-700 dark:text-blue-300 font-black text-sm">+<?php echo e($kpi['customer']['new'] ?? 0); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="relative overflow-x-auto rounded-xl border border-sky-200 dark:border-sky-800/60 shadow-md bg-gradient-to-br from-sky-50 to-white dark:from-sky-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-sky-700 dark:text-sky-300 mb-3">
                    <?php echo e(number_format(($kpi['service']['pppoe_online'] ?? 0) + ($kpi['service']['hotspot_online'] ?? 0))); ?>

                    <span class="text-sm font-normal text-sky-500">online</span>
                </div>
                <div class="grid grid-cols-3 gap-1.5">
                    <a href="<?php echo e(route('isp.pppoe-users.index')); ?>" class="rounded-lg px-2 py-1.5 bg-blue-100 dark:bg-blue-900/50 hover:bg-blue-200 dark:hover:bg-blue-800/70 transition-colors text-center">
                        <span class="block text-blue-600 dark:text-blue-400 font-semibold text-xs">PPPoE</span>
                        <span class="text-blue-700 dark:text-blue-300 font-black text-sm"><?php echo e($kpi['service']['pppoe_online'] ?? 0); ?></span>
                    </a>
                    <a href="<?php echo e(route('isp.pppoe-users.index')); ?>" class="rounded-lg px-2 py-1.5 bg-slate-200 dark:bg-slate-700/60 hover:bg-slate-300 dark:hover:bg-slate-600/70 transition-colors text-center">
                        <span class="block text-slate-500 dark:text-slate-400 font-semibold text-xs">Off</span>
                        <span class="text-slate-700 dark:text-slate-300 font-black text-sm"><?php echo e($kpi['service']['pppoe_offline'] ?? 0); ?></span>
                    </a>
                    <a href="<?php echo e(route('isp.hotspot-users.index')); ?>" class="rounded-lg px-2 py-1.5 bg-orange-100 dark:bg-orange-900/50 hover:bg-orange-200 dark:hover:bg-orange-800/70 transition-colors text-center">
                        <span class="block text-orange-600 dark:text-orange-400 font-semibold text-xs">Hotspot</span>
                        <span class="text-orange-700 dark:text-orange-300 font-black text-sm"><?php echo e($kpi['service']['hotspot_session'] ?? 0); ?></span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="relative overflow-x-auto rounded-xl border border-emerald-200 dark:border-emerald-800/60 shadow-md bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-2xl font-black text-emerald-700 dark:text-emerald-300 mb-3">Rp <?php echo e(number_format($kpi['billing']['tagihan'] ?? 0, 0, ',', '.')); ?></div>
                <div class="grid grid-cols-3 gap-1.5">
                    <a href="<?php echo e(route('billing.invoices.index')); ?>" class="rounded-lg px-2 py-1.5 bg-emerald-100 dark:bg-emerald-900/50 hover:bg-emerald-200 dark:hover:bg-emerald-800/70 transition-colors text-center">
                        <span class="block text-emerald-700 dark:text-emerald-400 font-semibold text-xs">Lunas</span>
                        <span class="text-emerald-800 dark:text-emerald-300 font-black text-sm"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($kpi['billing']['paid'] ?? 0) >= 1000000): ?><?php echo e(number_format(($kpi['billing']['paid'] ?? 0)/1000000, 1)); ?>Jt@else<?php echo e(number_format($kpi['billing']['paid'] ?? 0, 0, ',', '.')); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></span>
                    </a>
                    <a href="<?php echo e(route('billing.invoices.index')); ?>" class="rounded-lg px-2 py-1.5 bg-amber-100 dark:bg-amber-900/50 hover:bg-amber-200 dark:hover:bg-amber-800/70 transition-colors text-center">
                        <span class="block text-amber-600 dark:text-amber-400 font-semibold text-xs">Belum</span>
                        <span class="text-amber-700 dark:text-amber-300 font-black text-sm"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($kpi['billing']['unpaid'] ?? 0) >= 1000000): ?><?php echo e(number_format(($kpi['billing']['unpaid'] ?? 0)/1000000, 1)); ?>Jt@else<?php echo e(number_format($kpi['billing']['unpaid'] ?? 0, 0, ',', '.')); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></span>
                    </a>
                    <a href="<?php echo e(route('billing.invoices.index')); ?>" class="rounded-lg px-2 py-1.5 bg-red-100 dark:bg-red-900/50 hover:bg-red-200 dark:hover:bg-red-800/70 transition-colors text-center">
                        <span class="block text-red-600 dark:text-red-400 font-semibold text-xs">Overdue</span>
                        <span class="text-red-700 dark:text-red-300 font-black text-sm"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($kpi['billing']['overdue'] ?? 0) >= 1000000): ?><?php echo e(number_format(($kpi['billing']['overdue'] ?? 0)/1000000, 1)); ?>Jt@else<?php echo e(number_format($kpi['billing']['overdue'] ?? 0, 0, ',', '.')); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="relative overflow-x-auto rounded-xl border border-orange-200 dark:border-orange-800/60 shadow-md bg-gradient-to-br from-orange-50 to-white dark:from-orange-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-2xl font-black text-orange-700 dark:text-orange-300 mb-3">Rp <?php echo e(number_format($kpi['voucher']['revenue'] ?? 0, 0, ',', '.')); ?></div>
                <div class="grid grid-cols-2 gap-1.5">
                    <a href="<?php echo e(route('isp.vouchers.index')); ?>" class="rounded-lg px-2 py-1.5 bg-orange-100 dark:bg-orange-900/50 hover:bg-orange-200 dark:hover:bg-orange-800/70 transition-colors text-center">
                        <span class="block text-orange-700 dark:text-orange-400 font-semibold text-xs">Terjual</span>
                        <span class="text-orange-800 dark:text-orange-300 font-black text-sm"><?php echo e(number_format($kpi['voucher']['sold'] ?? 0, 0, ',', '.')); ?></span>
                    </a>
                    <a href="<?php echo e(route('isp.vouchers.index')); ?>" class="rounded-lg px-2 py-1.5 bg-slate-100 dark:bg-slate-700/50 hover:bg-slate-200 dark:hover:bg-slate-600/70 transition-colors text-center">
                        <span class="block text-slate-700 dark:text-slate-400 font-semibold text-xs">Tersedia</span>
                        <span class="text-slate-800 dark:text-slate-300 font-black text-sm"><?php echo e(number_format($kpi['voucher']['available'] ?? 0, 0, ',', '.')); ?></span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="relative overflow-x-auto rounded-xl border border-purple-200 dark:border-purple-800/60 shadow-md bg-gradient-to-br from-purple-50 to-white dark:from-purple-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-purple-700 dark:text-purple-300 mb-3">
                    <?php echo e(number_format($kpi['network']['onu_online'] ?? 0)); ?>

                    <span class="text-sm font-normal text-purple-500">ONU</span>
                </div>
                <div class="grid grid-cols-3 gap-1.5">
                    <a href="<?php echo e(route('isp.routers.index')); ?>" class="rounded-lg px-2 py-1.5 bg-violet-100 dark:bg-violet-900/50 hover:bg-violet-200 dark:hover:bg-violet-800/70 transition-colors text-center">
                        <span class="block text-violet-600 dark:text-violet-400 font-semibold text-xs">Router</span>
                        <span class="text-violet-700 dark:text-violet-300 font-black text-sm"><?php echo e($kpi['network']['router_online'] ?? 0); ?>/<?php echo e(($kpi['network']['router_online'] ?? 0) + ($kpi['network']['router_offline'] ?? 0)); ?></span>
                    </a>
                    <a href="#" class="rounded-lg px-2 py-1.5 bg-emerald-100 dark:bg-emerald-900/50 hover:bg-emerald-200 dark:hover:bg-emerald-800/70 transition-colors text-center">
                        ...
                        <span class="text-emerald-700 dark:text-emerald-300 font-black text-sm"><?php echo e($kpi['network']['olt_online'] ?? 0); ?></span>
                    </a>
                    <a href="#" class="rounded-lg px-2 py-1.5 bg-red-100 dark:bg-red-900/50 hover:bg-red-200 dark:hover:bg-red-800/70 transition-colors text-center">
                        ...
                        <span class="text-red-700 dark:text-red-300 font-black text-sm"><?php echo e($kpi['network']['onu_los'] ?? 0); ?></span>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-5">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs text-slate-500 dark:text-slate-400 font-mono"><?php echo e($systemInfo['radius_uptime'] ?? 'Unknown'); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.8)]"></span>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs text-slate-500 dark:text-slate-400 font-mono"><?php echo e($systemInfo['database_status'] ?? 'HEALTHY'); ?></span>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-5 flex flex-col">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="px-2 py-0.5 bg-red-100 dark:bg-red-900/50 text-red-600 rounded text-xs font-medium"><?php echo e($kpi['network']['onu_los'] ?? 0); ?> New</span>
                </div>
                <div class="flex-1 space-y-3 overflow-y-auto pr-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($kpi['network']['onu_los'] ?? 0) > 0): ?>
                    <div class="p-3 bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 rounded-lg">
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                <p class="text-sm font-medium text-red-800 dark:text-red-400"><?php echo e($kpi['network']['onu_los']); ?> ONU mengalami LOS</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
            <div class="p-5 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center">
                ...
                <a href="<?php echo e(route('isp.user-online.index')); ?>" class="text-sm text-primary-600 hover:text-primary-700">View All &rarr;</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700/50 text-sm">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topTraffic ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-800/50">
                            <td class="p-4 font-medium text-slate-900 dark:text-slate-100"><?php echo e($tt['name']); ?></td>
                            <td class="p-4 text-slate-600 dark:text-slate-400">
                                <span class="px-2 py-0.5 <?php echo e($tt['service'] == 'PPPOE' ? 'bg-blue-100 dark:bg-blue-900/50 text-blue-700' : 'bg-orange-100 dark:bg-orange-900/50 text-orange-700'); ?> rounded text-xs"><?php echo e($tt['service']); ?></span>
                            </td>
                            <td class="p-4 font-mono text-slate-500 dark:text-slate-400"><?php echo e($tt['ip']); ?></td>
                            <td class="p-4 text-right font-medium text-emerald-600"><?php echo e($tt['download']); ?></td>
                            <td class="p-4 text-right font-medium text-amber-600"><?php echo e($tt['upload']); ?></td>
                        </tr>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-5">
            ...
            <div class="relative border-l border-slate-200 dark:border-slate-700 ml-3 space-y-6">
                ...
                <div class="relative pl-6">
                    <span class="absolute -left-3 top-1 w-6 h-6 rounded-full bg-<?php echo e($act['color'] ?? 'blue'); ?>-100 flex items-center justify-center text-<?php echo e($act['color'] ?? 'blue'); ?>-600 shadow-sm ring-4 ring-white dark:ring-slate-800">
                        <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                    </span>
                    <p class="text-sm font-medium text-slate-900 dark:text-slate-100"><?php echo e($act['text'] ?? ''); ?></p>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1"><?php echo e($act['time'] ?? ''); ?></p>
                </div>
    ...
    <script>
        ...
        var revenueOptions = {
            theme: { mode: isDark ? 'dark' : 'light' },
                series: [{
                    name: 'Paid',
                    data: <?php echo json_encode($chartData['revenue']['paid'] ?? [], 15, 512) ?>
                }, {
                    name: 'Unpaid',
                    data: <?php echo json_encode($chartData['revenue']['unpaid'] ?? [], 15, 512) ?>
                }],
                chart: {
                    type: 'bar',
                    height: 256,
                ...
                dataLabels: { enabled: false },
                xaxis: {
                    categories: <?php echo json_encode($chartData['revenue']['categories'] ?? [], 15, 512) ?>,
                    labels: { style: { colors: '#94a3b8' } }
                },
                yaxis: {
                    labels: { style: { colors: '#94a3b8' } }
            ...
            var custOptions = {
                series: <?php echo json_encode($chartData['distribution'] ?? [], 15, 512) ?>,
                chart: {
                    type: 'donut',
                    height: 200,
                    fontFamily: 'inherit',
...
<?php /**PATH D:\dsBilling\resources\views/livewire/dashboard/index.blade.php ENDPATH**/ ?>