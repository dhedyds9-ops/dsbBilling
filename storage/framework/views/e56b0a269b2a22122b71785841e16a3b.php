            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sourceNodeId): ?>
                <div class="flex items-center justify-between p-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg border border-blue-200">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($sourceNodeName ?? 'Selected'); ?></span>
                    </div>
                    <button 
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($targetNodeId): ?>
                <div class="flex items-center justify-between p-2 bg-green-50 dark:bg-green-900/30 rounded-lg border border-green-200">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($targetNodeName ?? 'Selected'); ?></span>
                    </div>
                    <button 
        ...
        <div>
            ...
            <div class="grid grid-cols-3 gap-2">
                <button 
                    ...
                    class="px-3 py-2 text-xs font-medium rounded-lg transition-colors <?php echo e($optimizationType === 'distance' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
                >
                    Distance
                </button>
                <button 
                    wire:click="$set('optimizationType', 'latency')"
                    class="px-3 py-2 text-xs font-medium rounded-lg transition-colors <?php echo e($optimizationType === 'latency' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
                >
                    Latency
                </button>
                <button 
                    wire:click="$set('optimizationType', 'hops')"
                    class="px-3 py-2 text-xs font-medium rounded-lg transition-colors <?php echo e($optimizationType === 'hops' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
                >
                    Hops
                </button>
            </div>
        ...
        <div class="p-4 space-y-3 max-h-64 overflow-y-auto">
            ...
            <div class="space-y-1">
                ...
                <div class="flex items-center space-x-2 text-xs">
                    <span class="w-5 h-5 flex items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-600 font-medium"><?php echo e($index + 1); ?></span>
                    <span class="flex-1 text-gray-700 dark:text-gray-300"><?php echo e($segment['name'] ?? 'Node ' . ($index + 1)); ?></span>
    ...
    <div class="border-t border-gray-200 dark:border-gray-700">
        ...
        <div class="p-4 pt-0 space-y-2">
            ...
            <div 
                ...
                class="p-3 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:bg-gray-900/50 <?php echo e($selectedRouteId === $alt['id'] ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30' : ''); ?>"
            >
                <div class="flex items-center justify-between">
                    <span class="text-sm font-medium">Route <?php echo e($index + 1); ?></span>
                    <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($alt['distance'] ?? 0); ?> km</span>
                </div>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\gis\components\route-planner.blade.php ENDPATH**/ ?>