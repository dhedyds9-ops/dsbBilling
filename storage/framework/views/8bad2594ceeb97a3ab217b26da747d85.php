...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex justify-end gap-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                <a href="<?php echo e(route('acs.provisioning.templates.index')); ?>" class="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 rounded-lg hover:bg-slate-200 transition-colors">Kembali</a>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\acs\provisioning\template\create.blade.php ENDPATH**/ ?>