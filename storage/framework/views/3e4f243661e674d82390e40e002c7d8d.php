<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Edit Installation</h1>
            <p class="mt-1 text-sm text-slate-500">Edit informasi installation</p>
        </div>
    </div>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\crm\installation\edit.blade.php ENDPATH**/ ?>