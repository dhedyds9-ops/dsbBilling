    ...
    document.addEventListener('livewire:init', () => {
        ...
        Livewire.on('open-print-window', (data) => {
            ...
            Swal.fire({
                ...
                color: isDark ? '#f8fafc' : '#0f172a',
                html: `
                    <form id="printVoucherForm" method="POST" action="<?php echo e(route('isp.vouchers.print')); ?>" target="_blank">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\isp\voucher\index.blade.php ENDPATH**/ ?>