                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'customer-'.e($customer->id).''; ?>wire:key="customer-<?php echo e($customer->id); ?>" class="<?php echo e($rowBg); ?> transition-colors group">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap <?php echo e($textPrimary); ?>">
                                <a href="<?php echo e(route('reseller-portal.customers.show', $customer->id)); ?>" class="hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline transition-colors">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <a href="<?php echo e(route('reseller-portal.customers.show', $customer->id)); ?>" class="p-1.5 bg-amber-50 dark:bg-amber-900/30 text-amber-600 rounded hover:bg-amber-100 dark:bg-amber-900/50 dark:hover:bg-amber-900/50 transition-colors" title="Edit / Detail">
...
<?php /**PATH D:\dsBilling\resources\views\livewire\reseller-portal\customer\index.blade.php ENDPATH**/ ?>