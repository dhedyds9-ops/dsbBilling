...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>">
            ...
            <button type="submit" class="underline text-sm text-gray-600 hover:text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
...
<?php endif; ?>
<?php /**PATH D:\dsBilling\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>