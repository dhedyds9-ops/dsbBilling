<div class="space-y-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-slate-900 dark:text-slate-100">Tambah IP Pool</h1>
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Buat IP Pool baru dengan range IP untuk PPPoE atau Static Assignment.</p>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Otomatis terisi saat Start IP dimasukkan.</p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input wire:model.live="form.start_ip" type="text" class="mt-1 block w-full rounded-xl border-slate-300 dark:border-slate-600 dark:bg-slate-900 shadow-sm focus:border-blue-500 focus:ring-primary-500 sm:text-sm font-mono dark:bg-slate-900 dark:text-slate-100" placeholder="Contoh: 192.168.100.2">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="px-6 py-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700 flex justify-end gap-3 rounded-b-2xl">
            ...
            <button type="submit" class="px-4 py-2 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 inline-flex items-center">
                ...
                <span wire:loading.remove wire:target="save">Simpan IP Pool</span>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\isp\ip-pool\create.blade.php ENDPATH**/ ?>