                            ...
                            <div class="mb-10 ml-6">
                                ...
                                <div class="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                                    <div class="flex justify-between items-start mb-2">
                                        <div>
                                            <h3 class="font-bold text-gray-900 dark:text-gray-100"><?php echo e($version->settings['changelog'] ?? 'Tidak ada catatan' -: 'Tidak ada catatan perubahan'); ?></h3>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\i-s-p\voucher-template\versions.blade.php ENDPATH**/ ?>