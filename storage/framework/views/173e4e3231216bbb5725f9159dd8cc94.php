<div class="space-y-6">
    <div class="flex items-center gap-4">
        <a href="<?php echo e(route('admin.users.index')); ?>" class="p-2 text-slate-500 hover:text-slate-700 rounded-lg hover:bg-slate-100">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500"><?php echo e($user->name); ?></p>
        </div>
    </div>
        ...
        <div class="p-6 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="text-slate-900"><?php echo e($user->name); ?></p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-slate-900"><?php echo e($user->whatsapp ?? '-'); ?></p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Wilayah</label>
                    <p class="text-slate-900"><?php echo e($user->wilayah ?? '-'); ?></p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-slate-900"><?php echo e($user->created_at?->translatedFormat('d M Y H:i') ?? '-'); ?></p>
                </div>
            </div>
...
</div><?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\admin\user\show.blade.php ENDPATH**/ ?>