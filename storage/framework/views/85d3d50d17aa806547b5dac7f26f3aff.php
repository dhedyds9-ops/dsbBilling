<div>
    ...
    <div class="absolute bottom-4 right-4 z-[1000] bg-white bg-opacity-90 rounded px-2 py-1 text-xs text-gray-600">
        <span id="map-coords">Lat: <?php echo e($centerLat); ?> | Lon: <?php echo e($centerLon); ?></span>
    </div>
        ...
        document.addEventListener('livewire:load', function() {
            ...
            if (!window.gisMap) {
                window.gisMap = L.map('gis-map', {
                    center: [<?php echo e($centerLat); ?>, <?php echo e($centerLon); ?>],
                ...
                window.gisMap.on('moveend', function(e) {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('centerLat', center.lat);
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('centerLon', center.lng);
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('zoom', window.gisMap.getZoom());
                });
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\gis\components\map.blade.php ENDPATH**/ ?>