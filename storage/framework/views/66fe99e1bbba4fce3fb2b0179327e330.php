<?php $__env->startSection('page_title'); ?>
    <a href="<?php echo e(route('crm.customers.index')); ?>" class="flex items-center text-slate-500 hover:text-slate-800 dark:text-slate-200 dark:hover:text-slate-100 transition-colors mr-2">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                        ...
                        <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-800/50">
                            <td class="px-6 py-4 font-mono text-xs text-slate-900 dark:text-slate-100"><?php echo e($device['id']); ?></td>
                            <td class="px-6 py-4 text-slate-600 dark:text-slate-400"><?php echo e($device['type']); ?></td>
                            <td class="px-6 py-4 text-slate-600 dark:text-slate-400"><?php echo e($device['brand']); ?> <?php echo e($device['model']); ?></td>
                            <td class="px-6 py-4 font-mono text-xs text-slate-900 dark:text-slate-100"><?php echo e($device['serial']); ?></td>
                            <td class="px-6 py-4 text-slate-600 dark:text-slate-400"><?php echo e($device['wifi_ssid']); ?></td>
                            <td class="px-6 py-4">
                                <span class="px-2 py-1 text-xs font-semibold rounded-lg
                                    <?php if($device['status'] === 'active'): ?> bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700
                                    <?php else: ?> bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400
                                    <?php endif; ?>">
            ...
            <div class="space-y-3">
                ...
                <div class="h-72 bg-slate-100 dark:bg-slate-900 rounded-xl flex items-center justify-center border border-slate-200 dark:border-slate-700">
                    <iframe class="w-full h-full rounded-xl"
                        src="https://maps.google.com/maps?q=<?php echo e($customer->latitude); ?>,<?php echo e($customer->longitude); ?>&z=16&output=embed"
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-start gap-3 p-4 <?php echo e(!$notification['read'] ? 'bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800/50' : 'bg-slate-50 dark:bg-slate-800/50'); ?> rounded-xl">
                    <div class="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0
                        <?php echo e(!$notification['read'] ? 'bg-indigo-100 dark:bg-indigo-900/50' : 'bg-slate-200 dark:bg-slate-700'); ?>">
                        <span class="material-symbols-outlined notranslate <?php echo e(!$notification['read'] ? 'text-indigo-600' : 'text-slate-500 dark:text-slate-400'); ?>" translate="no" style="font-size:18px">notifications</span>
                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold text-slate-900 dark:text-slate-100"><?php echo e($notification['title']); ?></p>
                        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1"><?php echo e($notification['message']); ?></p>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\crm\customer\show.blade.php ENDPATH**/ ?>