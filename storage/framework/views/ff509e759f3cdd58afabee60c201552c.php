    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="min-w-0">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($f['type'] ?? 'select') === 'select'): ?>
                <select wire:model.live="filters.<?php echo e($f['key']); ?>" class="w-full text-sm rounded-md border border-slate-200 focus:ring-1 focus:ring-blue-500 bg-white dark:bg-slate-700 dark:border-slate-600 dark:text-slate-100 py-1.5 px-2">
            ...
            <?php elseif(($f['type'] ?? '') === 'date'): ?>
                <input wire:model.live="filters.<?php echo e($f['key']); ?>" type="date" class="w-full text-sm rounded-md border border-slate-200 focus:ring-1 focus:ring-blue-500 bg-white dark:bg-slate-700 dark:border-slate-600 dark:text-slate-100 py-1.5 px-2">
            <?php elseif(($f['type'] ?? '') === 'number'): ?>
                <input wire:model.live="filters.<?php echo e($f['key']); ?>" type="number" class="w-full text-sm rounded-md border border-slate-200 focus:ring-1 focus:ring-blue-500 bg-white dark:bg-slate-700 dark:border-slate-600 dark:text-slate-100 py-1.5 px-2">
            <?php elseif(($f['type'] ?? '') === 'text'): ?>
                <input wire:model.live="filters.<?php echo e($f['key']); ?>" type="text" class="w-full text-sm rounded-md border border-slate-200 focus:ring-1 focus:ring-blue-500 bg-white dark:bg-slate-700 dark:border-slate-600 dark:text-slate-100 py-1.5 px-2">
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\partials\enterprise\filters.blade.php ENDPATH**/ ?>