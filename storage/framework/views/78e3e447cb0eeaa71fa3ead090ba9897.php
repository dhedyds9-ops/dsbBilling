...
# Pastikan mikrotik ping ke IP server billing & sebaliknya me-reply
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('isp.olts.create')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg shadow-sm shadow-indigo-200 dark:shadow-none transition-all">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($selectedOLTs ?? $selectedOLT ?? $selectedOdcs ?? $selectedOdps ?? $selectedOlts)): ?>
    <div class="flex flex-wrap items-center gap-2 p-3 bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-100 dark:border-indigo-800 rounded-lg">
        <span class="text-sm text-indigo-800 dark:text-indigo-300 font-medium mr-2"><?php echo e(count($selectedOlts ?? $selectedOdcs ?? $selectedOdps ?? $selectedOlts)); ?> Terpilih</span>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $olts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $olt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        ?>
                        <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = ''.e($olt->id).''; ?>wire:key="<?php echo e($olt->id); ?>" class="hover:bg-slate-50 dark:hover:bg-slate-700/50 dark:bg-slate-800 transition-colors <?php if($olt->trashed()): ?> bg-red-50 dark:bg-red-900/20 <?php endif; ?>">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <input type="checkbox" wire:model.live="selectedOlts" value="<?php echo e($olt->id); ?>" class="w-4 h-4 text-primary-600 border-gray-300 dark:border-slate-600 rounded focus:ring-primary-500" <?php if($olt->trashed()): ?> disabled <?php endif; ?> />
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php else: ?>
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($olt->status === 'active' ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-semibold text-gray-900 dark:text-slate-100">
                                    <a href="<?php echo e(route('isp.olts.show', $olt->id)); ?>" class="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                                        <?php echo e($olt->name); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500 dark:text-slate-400 truncate max-w-[200px]" title="<?php echo e($olt->address); ?>"><?php echo e($olt->address ?: '-'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="font-mono text-sm text-gray-900 dark:text-slate-100"><?php echo e($olt->code); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900 dark:text-slate-100"><?php echo e($olt->pop->name ?? '-'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-600 dark:text-slate-300"><?php echo e($olt->vendor->name ?? '-'); ?></div>
                            </td>
                            
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($onuOnline > 0): ?>
                                    <a href="<?php echo e(route('isp.onus.index', ['oltFilter' => $olt->id])); ?>"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($onuOffline > 0): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <button type="button" wire:click="rowSync(<?php echo e($olt->id); ?>)" wire:loading.attr="disabled"
                                        ...
                                        <span class="material-symbols-outlined notranslate" wire:loading.class="animate-spin" wire:target="rowSync(<?php echo e($olt->id); ?>)" translate="no" style="font-size:16px">sync</span>
                                    </button>
                                    
                                    <a href="<?php echo e(route('isp.olts.show', $olt->id)); ?>" class="p-1.5 bg-slate-50 dark:bg-slate-700 text-slate-600 dark:text-slate-300 rounded hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-600 transition-colors" title="Detail">
                                        <span class="material-symbols-outlined notranslate" translate="no" style="font-size:16px">visibility</span>
                                    </a>
                                    
                                    <a href="<?php echo e(route('isp.olts.edit', $olt->id)); ?>" class="p-1.5 bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 rounded hover:bg-amber-100 dark:bg-amber-900/50 dark:hover:bg-amber-800/50 transition-colors" title="Edit">
                                        <span class="material-symbols-outlined notranslate" translate="no" style="font-size:16px">edit</span>
                                    </a>
                                    
                                    <button type="button" wire:click="delete(<?php echo e($olt->id); ?>)" wire:confirm="Yakin ingin menghapus OLT ini?" class="p-1.5 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded hover:bg-red-100 dark:bg-red-900/50 dark:hover:bg-red-800/50 transition-colors" title="Hapus">
...
<?php /**PATH D:\dsBilling\resources\views/livewire/isp/olt/index.blade.php ENDPATH**/ ?>