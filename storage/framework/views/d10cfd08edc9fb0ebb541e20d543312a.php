        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex-1">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($tower->name); ?></h1>
                        <div class="flex items-center gap-2 mt-1">
                            <span class="px-3 py-1 text-xs font-medium rounded-full 
                                        <?php if($tower->status === 'active'): ?> bg-green-100 dark:bg-green-900/50 text-green-600
                                        <?php else: ?> bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400
                                        <?php endif; ?>">
                                        <?php echo e(ucfirst($tower->status)); ?>

                                    </span>
                            <span class="text-sm text-slate-500 dark:text-slate-400 font-mono"><?php echo e($tower->code); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('isp.towers.edit', $tower->id)); ?>" class="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-50 dark:bg-slate-900/50 transition-colors">
                    Edit
                </a>
            </div>
        </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                 ...
                 <?php $__env->slot('header', null, []); ?> 
                    <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100">Informasi Tower</h3>
                 <?php $__env->endSlot(); ?>
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Kode</label>
                            <p class="text-slate-900 dark:text-slate-100 font-mono"><?php echo e($tower->code); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Nama</label>
                            <p class="text-slate-900 dark:text-slate-100"><?php echo e($tower->name); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Tinggi</label>
                            <p class="text-slate-900 dark:text-slate-100"><?php echo e($tower->height ?? '-'); ?> m</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Tipe</label>
                            <p class="text-slate-900 dark:text-slate-100"><?php echo e($tower->type ?? '-'); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Provinsi</label>
                            <p class="text-slate-900 dark:text-slate-100"><?php echo e($tower->province ?? '-'); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Kota</label>
                            <p class="text-slate-900 dark:text-slate-100"><?php echo e($tower->city ?? '-'); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Kecamatan</label>
                            <p class="text-slate-900 dark:text-slate-100"><?php echo e($tower->district ?? '-'); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Kelurahan</label>
                            <p class="text-slate-900 dark:text-slate-100"><?php echo e($tower->village ?? '-'); ?></p>
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Alamat</label>
                        <p class="text-slate-900 dark:text-slate-100"><?php echo e($tower->address ?? '-'); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Deskripsi</label>
                        <p class="text-slate-900 dark:text-slate-100"><?php echo e($tower->description ?? '-'); ?></p>
                    </div>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                 ...
                 <?php $__env->slot('header', null, []); ?> 
                    <h3 class="text-lg font-semibold text-slate-900 dark:text-slate-100">Lokasi & Statistik</h3>
                 <?php $__env->endSlot(); ?>
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Latitude</label>
                            <p class="text-slate-900 dark:text-slate-100 font-mono"><?php echo e($tower->latitude ?? '-'); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Longitude</label>
                            <p class="text-slate-900 dark:text-slate-100 font-mono"><?php echo e($tower->longitude ?? '-'); ?></p>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                        <div class="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg">
                            <p class="text-sm text-slate-500 dark:text-slate-400">POP</p>
                            <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($tower->pops->count()); ?></p>
                        </div>
                        <div class="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg">
                            <p class="text-sm text-slate-500 dark:text-slate-400">Access Point</p>
                            <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($tower->accessPoints->count()); ?></p>
                        </div>
                    </div>
                </div>
             <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\isp\tower\show.blade.php ENDPATH**/ ?>