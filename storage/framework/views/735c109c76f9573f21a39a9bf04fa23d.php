...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e($stats['in_use'] ?? 0); ?></p>
                </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-600 mt-1"><?php echo e($stats['retired'] ?? 0); ?></p>
                </div>
                ...
                <tbody class="divide-y divide-slate-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50">
                            <td class="px-6 py-4">
                                <div class="font-medium text-slate-900"><?php echo e($asset['name']); ?></div>
                            </td>
                            <td class="px-6 py-4 text-sm text-slate-600"><?php echo e($asset['serial_number']); ?></td>
                            <td class="px-6 py-4 text-sm text-slate-900"><?php echo e($asset['category']); ?></td>
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 text-xs font-medium rounded-full 
                                    <?php if($asset['status'] === 'in_use'): ?> bg-green-100 text-green-600
                                    <?php elseif($asset['status'] === 'available'): ?> bg-primary-100 text-primary-600
                                    <?php elseif($asset['status'] === 'maintenance'): ?> bg-yellow-100 text-yellow-600
                            ...
                            <td class="px-6 py-4 text-sm text-slate-600"><?php echo e($asset['warehouse']); ?></td>
                            <td class="px-6 py-4 text-sm text-slate-600"><?php echo e($asset['location']); ?></td>
                            <td class="px-6 py-4 text-sm text-slate-600"><?php echo e($asset['purchase_date']->format('d/m/Y')); ?></td>
                            <td class="px-6 py-4 text-sm text-slate-600"><?php echo e($asset['warranty_expires']->format('d/m/Y')); ?></td>
                            <td class="px-6 py-4">
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\inventory\asset-list.blade.php ENDPATH**/ ?>