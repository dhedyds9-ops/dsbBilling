    ...
    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div class="grid grid-cols-3 gap-2">
            <button 
                ...
                class="px-3 py-2 text-xs font-medium rounded-lg transition-colors <?php echo e($selectedMetric === 'coverage' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
            >
                Coverage
            </button>
            <button 
                wire:click="$set('selectedMetric', 'capacity')"
                class="px-3 py-2 text-xs font-medium rounded-lg transition-colors <?php echo e($selectedMetric === 'capacity' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
            >
                Capacity
            </button>
            <button 
                wire:click="$set('selectedMetric', 'performance')"
                class="px-3 py-2 text-xs font-medium rounded-lg transition-colors <?php echo e($selectedMetric === 'performance' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
            >
                Performance
            </button>
        </div>
    ...
    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
        <div class="grid grid-cols-2 gap-3">
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($metric['label'] ?? 'Metric'); ?></p>
                <p class="text-lg font-semibold text-gray-900 dark:text-gray-100"><?php echo e($metric['value'] ?? 0); ?><?php echo e($metric['unit'] ?? ''); ?></p>
        ...
        <div class="space-y-2 max-h-40 overflow-y-auto">
            ...
            <div class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-900/50 rounded">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($performer['name'] ?? 'Unknown'); ?></span>
                </div>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\gis\components\analytics.blade.php ENDPATH**/ ?>