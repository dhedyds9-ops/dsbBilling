    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('internet-packages.index')); ?>">
                <div class="row g-3">
                    <div class="col-md-4">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control dark:bg-slate-900 dark:text-slate-100" placeholder="Cari kode atau nama paket...">
                    </div>
                    <div class="col-md-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dsBilling\resources\views\internet-packages\index.blade.php ENDPATH**/ ?>