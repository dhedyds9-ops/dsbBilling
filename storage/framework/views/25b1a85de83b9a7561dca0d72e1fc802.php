...
<div class="max-w-4xl mx-auto space-y-6 pb-10">
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/20">
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Ubah detail profil dan hak akses untuk <?php echo e($user->name); ?>.</p>
        </div>
...
</div><?php /**PATH D:\dsBilling\resources\views\livewire\admin\user\edit.blade.php ENDPATH**/ ?>