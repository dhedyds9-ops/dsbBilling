<div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
    ...
    <div class="flex border-b border-gray-200 dark:border-gray-700">
        <button 
            ...
            class="flex-1 px-4 py-2 text-sm font-medium <?php echo e($activeTab === 'layers' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700 dark:text-gray-300'); ?>"
        >
            Layers
        </button>
        <button 
            wire:click="$set('activeTab', 'status')"
            class="flex-1 px-4 py-2 text-sm font-medium <?php echo e($activeTab === 'status' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700 dark:text-gray-300'); ?>"
        >
            Status
        </button>
        <button 
            wire:click="$set('activeTab', 'utilization')"
            class="flex-1 px-4 py-2 text-sm font-medium <?php echo e($activeTab === 'utilization' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700 dark:text-gray-300'); ?>"
        >
            Utilization
        </button>
    </div>
                ...
                <div class="space-y-2">
                    ...
                    <label class="flex items-center justify-between cursor-pointer hover:bg-gray-50 dark:bg-gray-900/50 p-2 rounded">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($layer['label']); ?></span>
                        </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between p-2 hover:bg-gray-50 dark:bg-gray-900/50 rounded">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($status['label']); ?></span>
                        </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center space-x-3 p-2 hover:bg-gray-50 dark:bg-gray-900/50 rounded">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($item['label']); ?></span>
                        </div>
                        <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($item['range']); ?></span>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
                <?php break; ?>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\gis\components\legend.blade.php ENDPATH**/ ?>