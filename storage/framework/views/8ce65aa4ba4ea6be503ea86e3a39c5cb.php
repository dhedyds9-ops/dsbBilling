...
<div class="flex items-center gap-3 <?php echo e($disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'); ?>" <?php echo e($attributes->only(['wire:model', 'wire:model.lazy', 'x-model'])); ?>>
    ...
    >
        <span
            class="inline-block <?php echo e($dotClasses); ?> transform rounded-full bg-white dark:bg-slate-800 shadow-sm transition-transform duration-200 ease-in-out <?php echo e($checked ? $translateClasses : 'translate-x-0.5'); ?>"
        ></span>
    </button>
...
<?php /**PATH D:\dsBilling\resources\views\components\forms\toggle.blade.php ENDPATH**/ ?>