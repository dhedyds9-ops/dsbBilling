            ...
            <div class="pt-4 border-t border-slate-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" wire:model="username" placeholder="username_pppoe" class="w-full px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex items-center justify-end gap-4 pt-4 border-t border-slate-200">
                <a href="<?php echo e(route('isp.pppoe-users.index')); ?>" class="px-6 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors">
                    Batal
                </a>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views/livewire/isp/pppoe-user/create.blade.php ENDPATH**/ ?>