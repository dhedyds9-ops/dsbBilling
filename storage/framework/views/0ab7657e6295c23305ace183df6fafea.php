<div class="min-h-screen noc-bg noc-text noc-mono" wire:poll.60s>
    <div class="max-w-[1800px] mx-auto px-4 py-4">
        <div class="flex items-center justify-between mb-4">
            <div>
                <h1 class="text-lg font-semibold noc-text tracking-tight">NOC · Alarms</h1>
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-3 mb-4">
            ...
            <div class="noc-summary-card">
                <div class="noc-summary-label">Open</div>
                <div class="noc-summary-value text-yellow-500"><?php echo e($summary['open']); ?></div>
            </div>
            <div class="noc-summary-card">
                <div class="noc-summary-label">Critical</div>
                <div class="noc-summary-value text-red-500"><?php echo e($summary['critical']); ?></div>
            </div>
            <div class="noc-summary-card">
                <div class="noc-summary-label">Warning</div>
                <div class="noc-summary-value text-yellow-500"><?php echo e($summary['warning']); ?></div>
            </div>
            <div class="noc-summary-card">
                <div class="noc-summary-label">Resolved</div>
                <div class="noc-summary-value text-emerald-500"><?php echo e($summary['resolved']); ?></div>
            </div>
        </div>
        ...
        <div class="noc-panel-bg border noc-border rounded p-3 mb-4">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-2 items-end">
                ...
                <div class="md:col-span-2">
                    ...
                    <select wire:model.live="levelFilter" class="w-full noc-input rounded px-2 py-1.5 text-sm dark:bg-slate-900 dark:text-slate-100">
                ...
                <div class="md:col-span-2">
                    ...
                    <select wire:model.live="statusFilter" class="w-full noc-input rounded px-2 py-1.5 text-sm dark:bg-slate-900 dark:text-slate-100">
                        <option value="all">All</option>
                ...
                <div class="md:col-span-2">
                    ...
                    <select wire:model.live="sourceFilter" class="w-full noc-input rounded px-2 py-1.5 text-sm dark:bg-slate-900 dark:text-slate-100">
                        <option value="all">All</option>
        ...
        <table class="w-full text-left text-sm text-slate-600 dark:text-slate-300">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700/60">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $alarms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alarm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-800/50 transition-colors border-b noc-border noc-row-hover transition">
                                <td class="p-3"><span class="inline-block px-2 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wider <?php echo e($levelClass); ?>"><?php echo e($alarm->level); ?></span></td>
                                <td class="p-3"><span class="inline-block px-2 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wider <?php echo e($statusClass); ?>"><?php echo e($alarm->status); ?></span></td>
                                <td class="p-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('noc.alarms.show')): ?>
                                        <a href="<?php echo e(route('noc.alarms.show', $alarm->id)); ?>" class="noc-text hover:text-blue-500 transition"><?php echo e($alarm->title); ?></a>
                                    <?php else: ?>
                                        <span class="noc-text"><?php echo e($alarm->title); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alarm->description): ?>
                                        <div class="text-[10px] noc-muted mt-0.5 max-w-md truncate"><?php echo e($alarm->description); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="p-3">
                                    <div class="noc-text-secondary"><?php echo e($alarm->source_name ?: class_basename($alarm->source_type)); ?></div>
                                    <div class="text-[10px] noc-muted opacity-60 mt-0.5"><?php echo e($alarm->source_type ? class_basename($alarm->source_type).' #'.$alarm->source_id : '—'); ?></div>
                                </td>
                                <td class="p-3">
                                    <div class="noc-text-secondary"><?php echo e($alarm->started_at->format('M d H:i')); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alarm->resolved_at): ?>
                                        <div class="text-[10px] text-emerald-500 mt-0.5">Res: <?php echo e($alarm->resolved_at->format('M d H:i')); ?></div>
                                    <?php elseif($alarm->started_at): ?>
                                ...
                                <td class="p-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alarm->acknowledgedBy): ?>
                                        <div class="noc-text-secondary"><?php echo e($alarm->acknowledgedBy->name); ?></div>
                                ...
                                <td class="p-3  text-right">
                                    <div class="inline-flex gap-1">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alarm->status !== 'resolved'): ?>
                                            <button wire:click="acknowledgeAlarm(<?php echo e($alarm->id); ?>)" class="px-2 py-1 text-[10px] border border-blue-700 rounded text-blue-500 hover:bg-blue-950 transition" onclick="return confirm('Acknowledge alarm #<?php echo e($alarm->id); ?>-')">ACK</button>
                                            <button wire:click="resolveAlarm(<?php echo e($alarm->id); ?>)" class="px-2 py-1 text-[10px] border border-green-700 rounded text-emerald-500 hover:bg-green-950 transition" onclick="return confirm('Resolve alarm #<?php echo e($alarm->id); ?>-')">RESOLVE</button>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('noc.alarms.show')): ?>
                                            <a href="<?php echo e(route('noc.alarms.show', $alarm->id)); ?>" class="px-2 py-1 text-[10px] border rounded noc-btn-outline transition">VIEW</a>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </td>
                            </tr>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($alarms->hasPages()): ?>
                <div class="px-3 py-2 border-t noc-border text-xs noc-muted">
                    <?php echo e($alarms->onEachSide(1)->links()); ?>
