<div>
    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div wire:click="$set('filters.status', 'unpaid')" class="relative overflow-x-auto rounded-xl border border-amber-200 dark:border-amber-800/60 shadow-sm bg-gradient-to-br from-amber-50 to-white dark:from-amber-950/50 dark:to-slate-800 group hover:shadow-md transition-all cursor-pointer">
                ...
                <div class="p-4 pt-5">
                    ...
                    <div class="flex items-baseline gap-2">
                        <span class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">Rp <?php echo e(number_format($stats['outstanding'], 0, ',', '.')); ?></span>
                    </div>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1"><?php echo e(number_format($stats['pending'])); ?> Invoice</p>
                </div>
            </div>
            ...
            <div wire:click="$set('filters.status', 'overdue')" class="relative overflow-x-auto rounded-xl border border-red-200 dark:border-red-800/60 shadow-sm bg-gradient-to-br from-red-50 to-white dark:from-red-950/50 dark:to-slate-800 group hover:shadow-md transition-all cursor-pointer">
                ...
                <div class="p-4 pt-5">
                    ...
                    <div class="flex items-baseline gap-2">
                        <span class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight"><?php echo e(number_format($stats['overdue'])); ?></span>
            ...
            <div wire:click="$set('filters.status', 'paid')" class="relative overflow-x-auto rounded-xl border border-emerald-200 dark:border-emerald-800/60 shadow-sm bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-950/50 dark:to-slate-800 group hover:shadow-md transition-all cursor-pointer">
                ...
                <div class="p-4 pt-5">
                    ...
                    <div class="flex items-baseline gap-2">
                        <span class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">Rp <?php echo e(number_format($stats['paid_amount'], 0, ',', '.')); ?></span>
                    </div>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1"><?php echo e(number_format($stats['paid'])); ?> Invoice</p>
                </div>
            </div>
            ...
            <div wire:click="$set('filters.status', '')" class="relative overflow-x-auto rounded-xl border border-blue-200 dark:border-blue-800/60 shadow-sm bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/50 dark:to-slate-800 group hover:shadow-md transition-all cursor-pointer">
                ...
                <div class="p-4 pt-5">
                    ...
                    <div class="flex items-baseline gap-2">
                        <span class="text-2xl font-black text-slate-800 dark:text-slate-100 tracking-tight">Rp <?php echo e(number_format($stats['total_amount'], 0, ',', '.')); ?></span>
                    </div>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1"><?php echo e(number_format($stats['total'])); ?> Keseluruhan</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-3 items-center justify-between bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
            ...
            <div class="flex items-center gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('administrator')): ?>
                <select wire:model.live="filters.reseller_id" class="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-3 pr-8 py-2 dark:bg-slate-900 dark:text-slate-100">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $resellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <a href="<?php echo e(route('billing.invoices.create')); ?>" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-2">
        ...
        <div class="flex items-center justify-between p-4 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-xl mb-4 mt-2 transition-all">
            ...
            <div class="flex items-center gap-2">
                ...
                <button wire:click="bulkDelete" wire:confirm="Yakin ingin menghapus <?php echo e(count($selected)); ?> invoice? Hanya invoice yang belum dibayar yang akan dihapus secara permanen." class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium transition-colors shadow-sm flex items-center gap-2">
                    <span class="material-symbols-outlined" style="font-size:18px">delete</span> Hapus (<?php echo e(count($selected)); ?>)
                </button>
            </div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-800/50 transition-colors">
                            <td class="px-4 py-3 whitespace-nowrap text-center">
                                <input type="checkbox" wire:model.live="selected" value="<?php echo e($invoice->id); ?>" 
                            ...
                            <td class="px-4 py-3 font-medium text-slate-900 dark:text-slate-100">
                                <a href="<?php echo e(route('billing.invoices.show', $invoice->id)); ?>" class="text-blue-600 dark:text-blue-400 hover:underline">
                                    <?php echo e($invoice->invoice_number); ?>

                                </a>
                            </td>
                            <td class="px-4 py-3 text-slate-700 dark:text-slate-300">
                                <div class="font-medium"><?php echo e($invoice->customer->name ?? '-'); ?></div>
                                <div class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($invoice->customer->code ?? '-'); ?></div>
                            </td>
                            ...
                            <td class="px-4 py-3">
                                ...
                                <?php elseif($invoice->status === 'unpaid' || $invoice->status === 'pending'): ?>
                                ...
                                <?php else: ?>
                                    <span class="inline-flex items-center gap-1.5 px-2 py-1 rounded-md text-xs font-medium bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-400"><?php echo e(ucfirst($invoice->status)); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            ...
                            <td class="px-4 py-3 text-center whitespace-nowrap">
                                <a href="<?php echo e(route('billing.invoices.show', $invoice->id)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-blue-50 hover:bg-blue-100 text-blue-600 dark:bg-blue-900/20 dark:hover:bg-blue-900/40 dark:text-blue-400 transition-colors" title="Detail">
                                    <span class="material-symbols-outlined notranslate" translate="no" style="font-size:18px">visibility</span>
                                </a>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($invoice->status, ['unpaid', 'partial', 'overdue', 'pending'])): ?>
                                    <button wire:click="openPaymentModal(<?php echo e($invoice->id); ?>)" type="button" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-emerald-50 hover:bg-emerald-100 text-emerald-600 dark:bg-emerald-900/20 dark:hover:bg-emerald-900/40 dark:text-emerald-400 transition-colors" title="Proses Bayar"> <span class="material-symbols-outlined notranslate" translate="no" style="font-size:18px">payments</span> </button>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                        </tr>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH D:\dsBilling\resources\views\livewire\billing\invoice\index.blade.php ENDPATH**/ ?>