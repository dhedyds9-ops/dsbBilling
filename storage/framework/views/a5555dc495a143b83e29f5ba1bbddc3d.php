...
<div class="space-y-6 pb-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?php echo e(route('admin.users.create')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-medium shadow-sm transition-colors whitespace-nowrap">
                        ...
                        <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-800/50 group transition-colors">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div class="font-bold text-slate-900 dark:text-slate-100"><?php echo e($user->name ?? '-'); ?></div>
                            ...
                            <td class="px-6 py-4">
                                <div class="font-medium text-slate-700 dark:text-slate-300">
                                    <?php echo e($user->job_function ?? '-'); ?>

                                </div>
                                <div class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($user->job_title ?? '-'); ?></div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a href="<?php echo e(route('admin.users.show', $user->id)); ?>" class="w-8 h-8 rounded-lg bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:bg-indigo-900/30 dark:hover:bg-indigo-900/30 flex items-center justify-center transition-colors">
                                        <span class="material-symbols-outlined notranslate" translate="no" style="font-size:18px">visibility</span>
                                    </a>
                                    <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="w-8 h-8 rounded-lg bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:bg-amber-900/30 dark:hover:bg-amber-900/30 flex items-center justify-center transition-colors">
...
</div><?php /**PATH D:\dsBilling\resources\views\livewire\admin\user\index.blade.php ENDPATH**/ ?>