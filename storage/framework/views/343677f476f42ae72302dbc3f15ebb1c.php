<div class="space-y-6">
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Edit Template Provisioning</h1>
            <p class="mt-1 text-sm text-slate-500">Edit template provisioning</p>
        </div>
    </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex justify-end gap-4 pt-4 border-t border-slate-200">
                <a href="<?php echo e(route('acs.provisioning.templates.index')); ?>" class="px-4 py-2 text-sm font-medium text-slate-700 bg-slate-100 rounded-lg hover:bg-slate-200 transition-colors">Kembali</a>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\acs\provisioning\template\edit.blade.php ENDPATH**/ ?>