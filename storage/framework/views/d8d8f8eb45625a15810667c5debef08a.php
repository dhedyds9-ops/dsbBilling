...
<?php $__env->startSection('title', 'Customers - WiFiNan'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="card">
            <div class="card-body flex items-center gap-4">
                ...
                <div>
                    <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($stats['total']); ?></p>
        ...
        <div class="card">
            <div class="card-body flex items-center gap-4">
                ...
                <div>
                    <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($stats['active']); ?></p>
        ...
        <div class="card">
            <div class="card-body flex items-center gap-4">
                ...
                <div>
                    <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($stats['inactive']); ?></p>
        ...
        <div class="card">
            <div class="card-body flex items-center gap-4">
                ...
                <div>
                    <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($stats['new_this_month']); ?></p>
        ...
        <div class="overflow-x-auto">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" value="<?php echo e($customer['id']); ?>" wire:model.live="selected" class="rounded border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100">
                        </td>
                        <td>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-slate-900 dark:text-slate-100"><?php echo e($customer['name']); ?></p>
                                    <p class="text-sm text-slate-500 dark:text-slate-400"><?php echo e($customer['email']); ?></p>
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="text-slate-700 dark:text-slate-300"><?php echo e($customer['package']); ?></span>
                        </td>
                        <td>
                            <span class="text-slate-700 dark:text-slate-300"><?php echo e($customer['area']); ?></span>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="text-sm text-slate-500 dark:text-slate-400"><?php echo e($customer['created_at']->diffForHumans()); ?></span>
                        </td>
                        <td class="text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('crm.customers.view', $customer['id'])); ?>" class="p-2 hover:bg-slate-100 dark:bg-slate-800 rounded-lg transition-colors">
                                ...
                                <a href="<?php echo e(route('crm.customers.edit', $customer['id'])); ?>" class="p-2 hover:bg-slate-100 dark:bg-slate-800 rounded-lg transition-colors">
                                    <svg class="w-4 h-4 text-slate-500 dark:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dsBilling\resources\views\livewire\crm\customer-list.blade.php ENDPATH**/ ?>