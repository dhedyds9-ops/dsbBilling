    ...
    <div class="flex items-center justify-between mb-4">
        <div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title): ?>
                <p class="text-sm font-medium text-slate-500"><?php echo e($title); ?></p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => $icon,'class' => 'w-5 h-5 text-slate-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($icon),'class' => 'w-5 h-5 text-slate-600']); ?>
...
<?php endif; ?>
    ...
    <div class="flex items-end justify-between">
        <div>
            <p class="text-3xl font-bold text-slate-900"><?php echo e($value); ?></p>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views/components/display/kpi-card.blade.php ENDPATH**/ ?>