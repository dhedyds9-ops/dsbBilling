...
<?php endif; ?>
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100">Buat Hotspot User Baru</h1>
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Tambahkan pengguna hotspot baru</p>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex items-center justify-end gap-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                <a href="<?php echo e(route('aaa.hotspot-users.index')); ?>" class="px-6 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-50 dark:bg-slate-900/50 transition-colors">
                    Batal
                </a>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\aaa\hotspot-user\create.blade.php ENDPATH**/ ?>