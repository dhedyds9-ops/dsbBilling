...
<?php
$baseClasses = 'h-5 w-5 rounded border-slate-300 dark:border-slate-600 text-primary-600 focus:ring-2 focus:ring-primary-500 focus:ring-offset-0';
...
<div class="flex items-start gap-3" <?php echo e($attributes->only(['wire:model', 'wire:model.lazy', 'x-model'])); ?>>
    ...
    <div class="space-y-1">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($label): ?>
            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 <?php echo e($disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'); ?>">
                <?php echo e($label); ?>
...
<?php /**PATH D:\dsBilling\resources\views\components\forms\checkbox.blade.php ENDPATH**/ ?>