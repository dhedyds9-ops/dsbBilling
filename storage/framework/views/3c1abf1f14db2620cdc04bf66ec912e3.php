            ...
            <div class="flex-1">
                <div class="flex items-center gap-3">
                    <div class="w-14 h-14 rounded-full bg-primary-100 flex items-center justify-center text-primary-600 text-2xl font-bold">
                        <?php echo e(substr($onu->name, 0, 1)); ?>

                    </div>
                    <div>
                        <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($onu->name); ?></h1>
                        <div class="flex items-center gap-2 mt-1">
                            <span class="px-3 py-1 text-xs font-medium rounded-full 
                                        <?php if($onu->status === 'active'): ?> bg-green-100 dark:bg-green-900/50 text-green-600
                                        <?php else: ?> bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400
                                        <?php endif; ?>">
                                        <?php echo e(ucfirst($onu->status)); ?>

                                    </span>
                            <span class="text-sm text-slate-500 dark:text-slate-400 font-mono"><?php echo e($onu->code); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('isp.onus.edit', $onu->id)); ?>" class="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-50 dark:bg-slate-900/50 transition-colors">
                    Edit
                </a>
            </div>
        </div>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                        <div class="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-lg">
                            ...
                            <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($onu->onuPorts->count()); ?></p>
                        </div>
                    </div>
                </div>
             <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\isp\onu\show.blade.php ENDPATH**/ ?>