<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <a href="<?php echo e(route('isp.pppoe-users.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                        ...
                        <tr class="<?php echo e($user->trashed() ? 'bg-slate-50' : ''); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$user->trashed()): ?>
                                        <button wire:click="toggleStatus(<?php echo e($user->id); ?>)" class="<?php echo e($user->status === 'active' ? 'text-yellow-600 hover:text-yellow-900' : 'text-green-600 hover:text-green-900'); ?>" title="<?php echo e($user->status === 'active' ? 'Suspend' : 'Aktifkan'); ?>">
