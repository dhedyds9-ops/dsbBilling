...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white dark:bg-slate-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH D:\dsBilling\resources\views\components\ui\modal.blade.php ENDPATH**/ ?>