                    ...
                    <div class="mt-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg max-h-64 overflow-y-auto">
                        ...
                        >
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($result['name']); ?></span>
                            </div>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1"><?php echo e($result['code']); ?></p>
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center space-x-3 cursor-pointer">
                            ...
                            <span class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-gray-700 dark:text-gray-300"><?php echo e(ucfirst($layerName)); ?></span>
                            </span>
                        </label>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                        ...
                        <div class="p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between">
                                <span class="flex items-center space-x-2">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($alarm['id']); ?></span>
                                </span>
                                <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($alarm['timestamp']); ?></span>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1"><?php echo e($alarm['message']); ?></p>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="flex-1 overflow-y-auto">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center space-x-3 mb-6">
                            ...
                            <div>
                                <h4 class="text-xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($nodeDetails['name'] ?? 'N/A'); ?></h4>
                                <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($nodeDetails['code'] ?? ''); ?></p>
                            </div>
                        </div>
                        ...
                        <div x-show="activeTab === 'overview'">
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-900 dark:text-gray-100"><?php echo e($nodeDetails['location']['name'] ?? 'N/A'); ?></p>
                                </div>
                                <div>
                                    <label class="text-sm text-gray-500 dark:text-gray-400">Coordinates</label>
                                    <p class="text-gray-900 dark:text-gray-100"><?php echo e($nodeDetails['location']['lat'] ?? 'N/A'); ?>, <?php echo e($nodeDetails['location']['lon'] ?? 'N/A'); ?></p>
                                </div>
                                <div>
                                    <label class="text-sm text-gray-500 dark:text-gray-400">Type</label>
                                    <p class="text-gray-900 dark:text-gray-100"><?php echo e(strtoupper($nodeDetails['type'] ?? 'N/A')); ?></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                                        ...
                                        <p class="text-xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($nodeDetails['capacity']['total_ports'] ?? 0); ?></p>
                                    </div>
                                    <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-3">
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Used Ports</p>
                                        <p class="text-xl font-semibold text-gray-900 dark:text-gray-100"><?php echo e($nodeDetails['capacity']['used_ports'] ?? 0); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\gis\index.blade.php ENDPATH**/ ?>