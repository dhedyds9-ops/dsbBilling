...
<div class="bg-surface-container/60 backdrop-blur-xl rounded-xl border border-outline-variant shadow-[0_0_15px_rgba(0,0,0,0.2)] p-6 shadow-soft" <?php echo e($attributes); ?>>
    
    <div class="flex items-center justify-between mb-4">
        <div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title): ?>
                <p class="text-sm font-medium text-gray-400"><?php echo e($title); ?></p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subtitle): ?>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5"><?php echo e($subtitle); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => $icon,'class' => 'w-5 h-5 text-gray-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($icon),'class' => 'w-5 h-5 text-gray-300']); ?>
...
<?php endif; ?>
    ...
    <div class="flex items-end justify-between">
        <div>
            <p class="text-3xl font-bold text-white font-heading font-bold"><?php echo e($value); ?></p>
...
<?php /**PATH D:\dsBilling\resources\views\components\display\kpi-card.blade.php ENDPATH**/ ?>