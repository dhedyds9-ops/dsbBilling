...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input" id="affects_revenue_sharing" name="affects_revenue_sharing" value="1" <?php echo e(old('affects_revenue_sharing') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\expense-categories\create.blade.php ENDPATH**/ ?>