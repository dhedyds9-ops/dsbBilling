<?php $__env->startSection('header_title', 'Pusat Bantuan'); ?>
...
<div class="p-4 sm:p-6 min-h-[calc(100vh-4rem)] space-y-4 pb-24">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPppoe): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isHotspot): ?>
    ...
    <div class="mt-8 text-center space-y-4">
        ...
        <a href="https://wa.me/<?php echo e($whatsappNumber); ?>" target="_blank" class="w-full flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-500/30 transition-all active:scale-95 text-[15px]">
...
<?php /**PATH D:\dsBilling\resources\views\livewire\customer-portal\support\contact-admin.blade.php ENDPATH**/ ?>