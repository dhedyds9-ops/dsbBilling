<div class="h-full flex flex-col space-y-4">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 px-2">
        ...
        <div class="relative overflow-hidden rounded border noc-border noc-panel-bg shadow-md group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-gray-100 mb-3"><?php echo e($stats['total_olt'] ?? 0); ?></div>
                <div class="text-xs text-gray-400 noc-mono"><span class="text-green-400"><?php echo e($stats['active_olt'] ?? 0); ?></span> OLT Aktif</div>
            </div>
        </div>
        ...
        <div class="relative overflow-hidden rounded border noc-border noc-panel-bg shadow-md group hover:shadow-lg transition-all cursor-pointer">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-gray-100 mb-3"><?php echo e($stats['total_odp'] ?? 0); ?></div>
                <div class="text-xs text-gray-400 noc-mono"><span class="text-emerald-400"><?php echo e($stats['active_odp'] ?? 0); ?></span> ODP Aktif</div>
            </div>
        </div>
        ...
        <div class="relative overflow-hidden rounded border noc-border noc-panel-bg shadow-md group hover:shadow-lg transition-all cursor-pointer">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-gray-100 mb-3"><?php echo e($stats['total_onu'] ?? 0); ?></div>
                <div class="text-xs text-gray-400 noc-mono"><span class="text-purple-400"><?php echo e($stats['online_onu'] ?? 0); ?></span> Online</div>
            </div>
        </div>
        ...
        <div class="relative overflow-hidden rounded border noc-border noc-panel-bg shadow-md group hover:shadow-lg transition-all cursor-pointer">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-red-400 mb-3"><?php echo e($stats['active_alarms'] ?? 0); ?></div>
                <div class="text-xs text-gray-400 noc-mono"><span class="text-red-500"><?php echo e($stats['critical_alarms'] ?? 0); ?></span> Kritis</div>
            </div>
        </div>
    </div>
    ...
    <div class="px-4 py-3 border-t noc-border flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="flex space-x-2">
            <button wire:click="$set('timeRange', '24h')" class="px-3 py-1 text-sm rounded <?php echo e($timeRange === '24h' ? 'bg-blue-900 text-blue-300' : 'text-gray-400 hover:bg-gray-800'); ?>">24h</button>
            <button wire:click="$set('timeRange', '7d')" class="px-3 py-1 text-sm rounded <?php echo e($timeRange === '7d' ? 'bg-blue-900 text-blue-300' : 'text-gray-400 hover:bg-gray-800'); ?>">7d</button>
            <button wire:click="$set('timeRange', '30d')" class="px-3 py-1 text-sm rounded <?php echo e($timeRange === '30d' ? 'bg-blue-900 text-blue-300' : 'text-gray-400 hover:bg-gray-800'); ?>">30d</button>
        </div>
        <select 
    ...
    <div class="border-t noc-border">
        ...
        <div class="divide-y divide-gray-800 max-h-64 overflow-y-auto noc-scroll">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentAlarms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alarm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="px-4 py-3 hover:bg-gray-800 cursor-pointer transition-colors" wire:click="$emit('showNodeDetails', '<?php echo e($alarm['node_id'] ?? ''); ?>', '<?php echo e($alarm['node_type'] ?? ''); ?>')">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <span class="status-indicator status-<?php echo e($alarm['severity'] ?? 'warning'); ?>"></span>
                        <span class="font-medium text-gray-200"><?php echo e($alarm['title'] ?? 'Unknown Alarm'); ?></span>
                    </div>
                    <span class="text-xs text-gray-500 dark:text-gray-400 noc-mono"><?php echo e($alarm['time_ago'] ?? ''); ?></span>
                </div>
                <p class="text-sm text-gray-400 mt-1 pl-5"><?php echo e($alarm['location'] ?? ''); ?></p>
            </div>
    ...
    <div class="border-t noc-border">
        ...
        <div class="divide-y divide-gray-800 max-h-64 overflow-y-auto noc-scroll">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $criticalNodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="px-4 py-3 hover:bg-gray-800 cursor-pointer transition-colors" wire:click="$emit('showNodeDetails', '<?php echo e($node['id'] ?? ''); ?>', '<?php echo e($node['type'] ?? ''); ?>')">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <span class="px-2 py-0.5 text-xs font-medium rounded border border-blue-500/30 text-blue-400 bg-blue-900/20 noc-mono">
                            <?php echo e(strtoupper($node['type'] ?? '')); ?>

                        </span>
                        <span class="font-medium text-gray-200"><?php echo e($node['name'] ?? 'Unknown'); ?></span>
                    </div>
                    <span class="px-2 py-0.5 text-xs font-medium rounded border noc-mono <?php echo e(($node['status'] ?? '') == 'critical' ? 'bg-red-900/20 text-red-400 border-red-500/30' : 'bg-yellow-900/20 text-yellow-400 border-yellow-500/30'); ?>">
                        <?php echo e(ucfirst($node['status'] ?? 'unknown')); ?>

                    </span>
                </div>
                <p class="text-sm text-gray-400 mt-1 pl-5"><?php echo e($node['location'] ?? ''); ?> - <?php echo e($node['utilization'] ?? 0); ?>% utilization</p>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            <div class="px-4 py-6 text-center text-gray-500 dark:text-gray-400">
...
<?php /**PATH D:\dsBilling\resources\views\livewire\gis\components\dashboard.blade.php ENDPATH**/ ?>