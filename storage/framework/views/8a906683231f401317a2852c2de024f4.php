...
<div class="space-y-6 pb-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="relative overflow-x-auto rounded-xl border border-indigo-200 dark:border-indigo-800/60 shadow-md bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-2xl font-black text-indigo-700 dark:text-indigo-300 mb-1"><?php echo e(number_format($stats['total'])); ?></div>
        ...
        <div class="relative overflow-x-auto rounded-xl border border-blue-200 dark:border-blue-800/60 shadow-md bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-2xl font-black text-blue-700 dark:text-blue-300 mb-1"><?php echo e(number_format($stats['new'])); ?></div>
        ...
        <div class="relative overflow-x-auto rounded-xl border border-amber-200 dark:border-amber-800/60 shadow-md bg-gradient-to-br from-amber-50 to-white dark:from-amber-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-2xl font-black text-amber-700 dark:text-amber-300 mb-1"><?php echo e(number_format($stats['followup'])); ?></div>
        ...
        <div class="relative overflow-x-auto rounded-xl border border-emerald-200 dark:border-emerald-800/60 shadow-md bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-2xl font-black text-emerald-700 dark:text-emerald-300 mb-1"><?php echo e(number_format($stats['converted'])); ?></div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?php echo e(route('crm.leads.create')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-medium shadow-sm transition-colors">
            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700/50">
                    ...
                    <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-800/50 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-full <?php echo e($lead->status === 'converted' ? 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/50 dark:text-emerald-400' : 'bg-indigo-100 text-indigo-600 dark:bg-indigo-900/50 dark:text-indigo-400'); ?> flex items-center justify-center font-bold flex-shrink-0">
                                    <?php echo e(substr($lead->name ?? 'L', 0, 1)); ?>

                                </div>
                                <div>
                                    <a href="<?php echo e(route('crm.leads.show', $lead->id)); ?>" class="font-bold text-slate-900 dark:text-slate-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-slate-600 dark:text-slate-400 max-w-xs truncate" title="<?php echo e($lead->address); ?>">
                                <?php echo e($lead->address ?? '-'); ?>

                            </div>
                            <div class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                                Sumber: <span class="font-medium"><?php echo e($lead->source ?? 'Manual'); ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold
                                <?php if($lead->status === 'new'): ?> bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-400
                                <?php elseif($lead->status === 'contacted'): ?> bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-400
                                <?php elseif($lead->status === 'qualified'): ?> bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-400
                                <?php elseif($lead->status === 'converted'): ?> bg-emerald-100 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-400
                                <?php else: ?> bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-400
                                <?php endif; ?>
                            ">
                                <span class="w-1.5 h-1.5 rounded-full 
                                    <?php if($lead->status === 'new'): ?> bg-blue-500 animate-pulse
                                    <?php elseif($lead->status === 'contacted'): ?> bg-amber-500
                                    <?php elseif($lead->status === 'qualified'): ?> bg-purple-500
                                    <?php elseif($lead->status === 'converted'): ?> bg-emerald-500
                                    <?php else: ?> bg-red-500
                                    <?php endif; ?>
                                "></span>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\crm\lead\index.blade.php ENDPATH**/ ?>