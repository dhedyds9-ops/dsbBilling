                ...
                <div class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Source Code (HTML/CSS)</h3>
                        <button wire:click="validateContent" class="text-sm bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded hover:bg-gray-200">
                            Validasi Syntax
                        </button>
                    </div>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\i-s-p\voucher-template\editor.blade.php ENDPATH**/ ?>