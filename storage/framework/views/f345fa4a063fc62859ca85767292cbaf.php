...
<div>
  <?php echo $__env->make('partials.enterprise.list-toolbar', [
    'title' => 'BHP & USO',
    'primaryLabel' => 'Bayar BHP/USO',
    'primaryAction' => "confirmRowAction('pay-bhp', 0)",
    'actions' => [
      ['label' => 'Export CSV', 'icon' => 'download', 'action' => 'exportCsv()'],
      ['label' => 'Cetak SPT', 'icon' => 'printer', 'action' => 'cetakSkri()'],
    ],
    'searchPlaceholder' => 'Cari no bukti / periode...',
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\keuangan\bhp-uso\index.blade.php ENDPATH**/ ?>