...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => 'Audit Trail','subtitle' => 'Log semua aktivitas pengguna dan sistem']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Audit Trail','subtitle' => 'Log semua aktivitas pengguna dan sistem']); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $auditLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
          <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-700/50 transition-colors">
            <td class="px-4 py-2.5 text-slate-500 dark:text-slate-400 whitespace-nowrap text-xs">
              <?php echo e(optional($log->created_at)->format('d/m/Y H:i:s')); ?>

            </td>
            <td class="px-4 py-2.5">
              <span class="text-slate-700 dark:text-slate-200 font-medium text-xs">
                <?php echo e($log->user_id ?? 'System'); ?>
            ...
            <td class="px-4 py-2.5">
              ...
              ?>
              <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-semibold <?php echo e($evtColor); ?>">
                <?php echo e($log->event ?? ','); ?>

              </span>
            </td>
            <td class="px-4 py-2.5 text-slate-600 dark:text-slate-300 text-xs font-mono">
              <?php echo e(class_basename($log->model ?? ',')); ?>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\admin\audit-trail\index.blade.php ENDPATH**/ ?>