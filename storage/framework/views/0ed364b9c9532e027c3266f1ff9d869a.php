<div>
  <div class="px-4 py-3 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between flex-wrap gap-3">
    ...
    <div class="flex items-center gap-2">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($savedStatus): ?>
        ...
        <span class="material-symbols-outlined notranslate" translate="no" style="font-size:14px"><?php echo e($savedStatus==='saved' ? 'check' : 'warning'); ?></span>
  ...
  <div class="px-3 py-2 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
    <nav class="flex items-center gap-1 text-sm font-medium overflow-x-auto">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['radius'=>'Radius Engine','radius_client'=>'Radius Client']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
  ...
  <div class="p-4">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'radius'): ?>
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-4 h-fit sticky top-4">
          ...
          <div class="grid grid-cols-2 gap-2 text-xs">
            <div class="rounded bg-slate-50 dark:bg-slate-700/40 p-2.5"><div class="text-[10px] text-slate-500 dark:text-slate-400">Auth Endpoint</div><div class="font-mono mt-0.5 text-slate-800 dark:text-slate-100 truncate"><?php echo e($radiusForm['auth_host'] ?? '-'); ?>:<?php echo e($radiusForm['auth_port'] ?? '1812'); ?></div></div>
            <div class="rounded bg-slate-50 dark:bg-slate-700/40 p-2.5"><div class="text-[10px] text-slate-500 dark:text-slate-400">Acct Endpoint</div><div class="font-mono mt-0.5 text-slate-800 dark:text-slate-100 truncate"><?php echo e($radiusForm['acct_host'] ?? '-'); ?>:<?php echo e($radiusForm['acct_port'] ?? '1813'); ?></div></div>
            <div class="rounded bg-slate-50 dark:bg-slate-700/40 p-2.5"><div class="text-[10px] text-slate-500 dark:text-slate-400">CoA/PoD (RFC 5176)</div><div class="font-mono mt-0.5 text-slate-800 dark:text-slate-100 truncate"><?php echo e($radiusForm['coa_host'] ?? '-'); ?>:<?php echo e($radiusForm['coa_port'] ?? '3799'); ?></div></div>
            <div class="rounded bg-slate-50 dark:bg-slate-700/40 p-2.5"><div class="text-[10px] text-slate-500 dark:text-slate-400">Protocol Stack</div><div class="font-mono mt-0.5 text-slate-800 dark:text-slate-100"><?php echo e(strtoupper($radiusForm['proto'] ?? 'PAP')); ?> · <?php echo e($radiusForm['nas_port_type'] ?? 'PPPoE'); ?></div></div>
          </div>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\pengaturan\koneksi\index.blade.php ENDPATH**/ ?>