<?php $__env->startSection('header_title', 'Profil Saya'); ?>
...
<div class="p-4 sm:p-6 min-h-[calc(100vh-4rem)] space-y-6 pb-20">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message): ?>
        <div class="p-3 rounded-xl text-sm font-medium \<?php echo e($messageType === 'success' ? 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 border border-emerald-100' : 'bg-red-50 dark:bg-red-900/30 text-red-600 border border-red-100'); ?>">
            <?php echo e($message); ?>
...
</div><?php /**PATH D:\dsBilling\resources\views\livewire\customer-portal\profile\profile.blade.php ENDPATH**/ ?>