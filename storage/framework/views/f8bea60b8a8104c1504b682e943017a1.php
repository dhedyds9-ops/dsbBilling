<div>
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div>
            <a href="<?php echo e(route('reseller-portal.reports.sales.print')); ?>" target="_blank" class="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-700 flex items-center gap-2 transition-colors shadow-sm text-sm font-medium">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($totalCustomers); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($totalVouchers); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-slate-900 dark:text-slate-100"><?php echo e($thisMonthInvoices); ?></p>
            </div>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $recentSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-800/50">
                            <td class="px-6 py-3 text-slate-600 dark:text-slate-400"><?php echo e($sale->updated_at->format('d M Y H:i')); ?></td>
                            <td class="px-6 py-3 font-medium text-blue-600 dark:text-blue-400"><?php echo e($sale->invoice_number); ?></td>
                            <td class="px-6 py-3 text-slate-700 dark:text-slate-300"><?php echo e($sale->customer->name ?? '-'); ?></td>
                            <td class="px-6 py-3 text-right font-mono font-bold text-emerald-600 dark:text-emerald-400">Rp <?php echo e(number_format($sale->total_amount, 0, ',', '.')); ?></td>
                        </tr>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\reseller-portal\reports\sales.blade.php ENDPATH**/ ?>