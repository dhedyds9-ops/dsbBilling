<div class="p-4 sm:p-6 min-h-[calc(100vh-4rem)] flex flex-col items-center pb-24" id="speedtest-container">
    <?php $__env->startSection('header_title', 'Speedtest'); ?>
    ...
    <div class="text-center w-full mb-6 mt-4">
        ...
        <p class="text-xs text-slate-500 dark:text-slate-400 font-medium tracking-wide uppercase mt-1">Network Diagnostic Tool</p>
    </div>
    ...
    <div class="relative w-64 h-64 sm:w-72 sm:h-72 mb-8 flex items-center justify-center">
        ...
        <div class="relative z-10 w-52 h-52 sm:w-60 sm:h-60 rounded-full bg-white dark:bg-slate-900 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] dark:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] border border-slate-50 dark:border-slate-800 flex flex-col items-center justify-center">
            ...
            <div class="absolute top-6">
                <span id="st-icon-speed" class="material-symbols-outlined text-[32px] transition-colors duration-300 text-slate-300 dark:text-slate-700 dark:text-slate-300">speed</span>
            </div>
    ...
    <div class="w-full max-w-sm bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/60 p-4 mb-6 flex flex-col gap-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">IP Publik</p>
                    <p class="text-xs font-bold text-slate-700 dark:text-slate-300"><?php echo e($publicIp ?? '-'); ?></p>
                </div>
            </div>
            <div class="text-right">
                <p class="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Server</p>
                <p class="text-xs font-bold text-slate-700 dark:text-slate-300"><?php echo e($ispName ?? '-'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full max-w-sm mt-auto">
        <button type="button" id="st-btn-start" onclick="window.startVanillaSpeedTest()"
                class="w-full font-black py-4 rounded-2xl transition-all duration-300 active:scale-95 flex items-center justify-center gap-2 overflow-hidden relative group bg-slate-900 text-white dark:bg-white dark:bg-slate-800 dark:text-slate-900 dark:text-slate-100 shadow-lg hover:shadow-xl hover:shadow-slate-900/20">
    ...
    <script data-navigate-once>
        ...
        window.startVanillaSpeedTest = async function() {
            ...
            btnStart.className = "w-full font-black py-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden relative bg-slate-100 text-slate-400 dark:bg-slate-800 dark:text-slate-500 dark:text-slate-400 cursor-not-allowed";
            ...
            iconSpeed.classList.replace('dark:text-slate-700 dark:text-slate-300', 'text-teal-500');
            ...
            try {
                ...
                setTimeout(() => {
                    ...
                    btnStart.className = "w-full font-black py-4 rounded-2xl transition-all duration-300 active:scale-95 flex items-center justify-center gap-2 overflow-hidden relative group bg-slate-900 text-white dark:bg-white dark:bg-slate-800 dark:text-slate-900 dark:text-slate-100 shadow-lg hover:shadow-xl hover:shadow-slate-900/20";
                    ...
                    iconSpeed.classList.replace('text-teal-500', 'dark:text-slate-700 dark:text-slate-300');
...
</div><?php /**PATH D:\dsBilling\resources\views\livewire\customer-portal\self-service\speed-test.blade.php ENDPATH**/ ?>