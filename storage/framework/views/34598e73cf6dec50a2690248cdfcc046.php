        ...
        >
            <div class="flex items-start justify-between">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($alarm['title'] ?? 'Unknown Alarm'); ?></p>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($alarm['description'] ?? ''); ?></p>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\gis\components\alarm-panel.blade.php ENDPATH**/ ?>