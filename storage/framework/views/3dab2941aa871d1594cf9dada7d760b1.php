<div class="p-6 bg-white dark:bg-slate-800 rounded-lg shadow-md max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-slate-100">Create Employee</h2>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="mt-8">
            <button type="submit" class="px-6 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition">Save Employee</button>
        </div>
    </form>
</div>
<?php /**PATH D:\dsBilling\resources\views\livewire\admin\employee\create.blade.php ENDPATH**/ ?>