            ...
            <div class="p-4">
              <div class="flex items-center justify-between mb-2 flex-wrap gap-2">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-[11px] px-1.5 py-0.5 rounded bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 font-mono"><?php echo e($t['code']); ?></span>
                  <span class="font-semibold text-slate-800 dark:text-slate-100 text-sm"><?php echo e($t['name']); ?></span>
                </div>
              </div>
              <textarea wire:model="templates.<?php echo e($i); ?>.content" rows="5" class="w-full px-3 py-2 text-xs border border-slate-200 dark:border-slate-700 rounded-md bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 font-mono leading-relaxed whitespace-pre dark:bg-slate-900 dark:text-slate-100"></textarea>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\pengaturan\whatsapp\index.blade.php ENDPATH**/ ?>