<div x-data="{ open: false }" @keydown.escape.window="open = false" @open-notifications.window="open = true" @close-notifications.window="open = false" @refresh-notifications.window="$refresh" class="relative">
    ...
    <div
        ...
        @click.stop
        class="absolute right-0 mt-2 w-80 bg-white rounded-xl border border-slate-200 shadow-soft-lg overflow-hidden z-50"
        style="display: none;"
    >
        ...
        <div class="max-h-80 overflow-y-auto">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($notifications) > 0): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = ''.e($notification['id']).''; ?>wire:key="<?php echo e($notification['id']); ?>" class="px-4 py-3 border-b border-slate-100 hover:bg-slate-50 transition-colors cursor-pointer <?php echo e(!$notification['read'] ? 'bg-primary-50' : ''); ?>">
                        <div class="flex items-start gap-3">
                            <div class="mt-0.5 flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center <?php echo e($notification['type'] === 'warning' ? 'bg-yellow-100 text-yellow-600' : ($notification['type'] === 'success' ? 'bg-green-100 text-green-600' : 'bg-blue-100 text-blue-600')); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notification['type'] === 'warning'): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$notification['read']): ?>
                            <div class="flex items-center justify-end mt-2 gap-2">
                                <button wire:click="markAsRead(<?php echo e($notification['id']); ?>)" class="text-xs text-primary-600 hover:text-primary-700">
                                    Mark as read
                                </button>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="px-4 py-3 border-t border-slate-200">
            <div class="flex items-center justify-between">
                <button wire:click="clearAll" class="text-xs text-slate-500 hover:text-slate-700">
                    Clear all
                </button>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views/livewire/notification-center.blade.php ENDPATH**/ ?>