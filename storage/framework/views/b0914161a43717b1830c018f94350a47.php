<?php $__env->startSection('page_title'); ?>
    ...
    <span class="text-lg">Daftar Hotspot</span>
...
<div class="space-y-5 pb-10">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div class="relative overflow-x-auto rounded-xl border border-indigo-200 dark:border-indigo-800/60 shadow-md bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-950/50 dark:to-slate-800 group hover:shadow-lg transition-all">
            ...
            <div class="p-4 pt-5">
                <h3 class="text-xs font-bold text-indigo-500 dark:text-indigo-400 uppercase tracking-widest mb-2">Total Hotspot</h3>
                <div class="text-4xl font-black text-indigo-700 dark:text-indigo-300 mb-3"><?php echo e(number_format($stats['total'] ?? 0)); ?></div>
                <div class="text-xs text-slate-500 dark:text-slate-400">Semua User Hotspot</div>
            </div>
        </div>
        ...
        <div wire:click="$set('filters.status', 'active')" class="relative overflow-x-auto rounded-xl border border-emerald-200 dark:border-emerald-800/60 shadow-md bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-950/50 dark:to-slate-800 group hover:shadow-lg transition-all cursor-pointer">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-emerald-700 dark:text-emerald-300 mb-3"><?php echo e(number_format($stats['active'] ?? 0)); ?></div>
        ...
        <div wire:click="$set('filters.status', 'online')" class="relative overflow-x-auto rounded-xl border border-cyan-200 cursor-pointer dark:border-cyan-800/60 shadow-md bg-gradient-to-br from-cyan-50 to-white dark:from-cyan-950/50 dark:to-slate-800 group transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-cyan-700 dark:text-cyan-300 mb-3"><?php echo e(number_format($stats['online'] ?? 0)); ?></div>
        ...
        <div wire:click="$set('filters.status', 'offline')" class="relative overflow-x-auto rounded-xl border border-slate-200 cursor-pointer dark:border-slate-700/60 shadow-md bg-gradient-to-br from-slate-50 to-white dark:from-slate-900/50 dark:to-slate-800 group transition-all">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-slate-700 dark:text-slate-300 mb-3"><?php echo e(number_format(max(0, ($stats['active'] ?? 0) - ($stats['online'] ?? 0)))); ?></div>
                <div class="text-xs text-slate-500 dark:text-slate-400">Live dari Mikrotik</div>
            </div>
        </div>
        ...
        <div wire:click="$set('filters.status', 'suspended')" class="relative overflow-x-auto rounded-xl border border-red-200 dark:border-red-800/60 shadow-md bg-gradient-to-br from-red-50 to-white dark:from-red-950/50 dark:to-slate-800 group hover:shadow-lg transition-all cursor-pointer">
            ...
            <div class="p-4 pt-5">
                ...
                <div class="text-4xl font-black text-red-700 dark:text-red-300 mb-3"><?php echo e(number_format($stats['suspended'] ?? 0)); ?></div>
                <div class="text-xs text-slate-500 dark:text-slate-400">Klik untuk memfilter</div>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('reseller-portal.customers.hotspot.create')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg shadow-sm shadow-indigo-200 dark:shadow-none transition-all">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700/50">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $hotspotUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $isOnline = $user->is_online ?? false;
                            $isSuspend = $user->status === 'suspended';
                            $dynamicId = $user->customer ? $user->customer->code : '-';
                            $layanan = 'Hotspot';
                        ...
                        <tr class="<?php echo e($rowBg); ?>">
                            <td class="px-4 py-3">
                                <input type="checkbox" wire:model.live="selectedIds" value="<?php echo e($user->id); ?>" class="rounded border-slate-300 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:bg-slate-700 dark:border-slate-600">
                            </td>
                            <td class="px-4 py-3 font-mono text-xs <?php echo e($idColor); ?>">
                                  <div class="flex items-center gap-2">
                                      <input type="checkbox" wire:change="toggleStatus(<?php echo e($user->id); ?>)" 
                            ...
                            <td class="px-4 py-3 <?php echo e($textPrimary); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($user->customer->id)): ?>
                                    <a href="<?php echo e(route('reseller-portal.customers.show', $user->customer->id)); ?>" class="hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline transition-colors">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <span class="text-sm font-semibold <?php echo e($isSuspend ? 'text-red-700 dark:text-red-400' : 'text-indigo-600 dark:text-indigo-400'); ?> font-mono"><?php echo e($user->username); ?></span>
                                    <button type="button" onclick="navigator.clipboard.writeText('<?php echo e($user->username); ?>'); alert('Username disalin!')" class="text-slate-400 hover:text-indigo-500 transition-colors" title="Salin Username">
                            ...
                            <td class="px-4 py-3" x-data="{ showPw: false }">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs font-mono <?php echo e($textSecondary); ?>" x-show="showPw" x-cloak><?php echo e($user->password); ?></span>
                                    ...
                                    <button type="button" onclick="navigator.clipboard.writeText('<?php echo e($user->password); ?>'); alert('Password disalin!')" class="text-slate-400 hover:text-indigo-500 transition-colors" title="Salin Password">
                                        <span class="material-symbols-outlined notranslate" translate="no" style="font-size:14px">content_copy</span>
                                    </button>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-3 <?php echo e($textSecondary); ?> font-mono text-xs">
                                <?php echo e($user->static_ip ?? $user->ip_address ?? 'Dynamic'); ?>

                            </td>
                            <td class="px-4 py-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->reseller): ?>
                            ...
                            <td class="px-4 py-3 <?php echo e($textSecondary); ?>">
                                <?php echo e($user->customer->phone ?? '-'); ?>

                            </td>
                            <td class="px-4 py-3 text-center whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->status === 'suspended'): ?>
                            ...
                            <td class="px-4 py-3 <?php echo e($textSecondary); ?> text-xs font-mono">
                                <?php echo e($tglLogin); ?>

                            </td>
                            <td class="px-4 py-3 <?php echo e($textSecondary); ?> text-xs font-mono">
                                <?php echo e($tglLogout); ?>

                            </td>
                            <td class="px-4 py-3 <?php echo e($textSecondary); ?> text-xs">
                                <?php echo e($user->subscription->next_billing_date ? \Carbon\Carbon::parse($user->subscription->next_billing_date)->format('d-m-Y') : '-'); ?>

                            </td>
                            <td class="px-4 py-3 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-1">
                                    <a href="<?php echo e(route('reseller-portal.customers.show', $user->customer->id ?? 0)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-900/50 text-indigo-600 dark:text-indigo-400 transition-colors" title="Edit">
                                        <span class="material-symbols-outlined notranslate" translate="no" style="font-size:18px">edit</span>
                                    </a>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($user->customer->id)): ?>
                                        <a href="<?php echo e(route('reseller-portal.customers.show', $user->customer->id)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-sky-50 hover:bg-sky-100 dark:bg-sky-900/30 dark:hover:bg-sky-900/50 text-sky-600 dark:text-sky-400 transition-colors" title="Portal Customer 360">
                                            <span class="material-symbols-outlined notranslate" translate="no" style="font-size:18px">account_circle</span>
                                        </a>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <button wire:click="delete(<?php echo e($user->id); ?>, null)" onclick="confirm('Yakin ingin menghapus user ini?') || event.stopImmediatePropagation()" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-red-50 hover:bg-red-100 dark:bg-red-900/30 dark:hover:bg-red-900/50 text-red-600 dark:text-red-400 transition-colors" title="Hapus">
                        ...
                        <tr>
                            <td colspan="12" class="px-4 py-8 text-center text-slate-500 dark:text-slate-400">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p>Belum ada data Hotspot User</p>
                                </div>
                            </td>
                        </tr>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\reseller-portal\customer\hotspot.blade.php ENDPATH**/ ?>