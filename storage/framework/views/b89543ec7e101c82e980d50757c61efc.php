...
<div class="h-full flex flex-col noc-bg">
    ...
    <div class="flex-none px-3 py-2 border-b noc-border flex items-center justify-between gap-3 flex-wrap noc-panel-bg">
        <div class="flex items-center gap-3">
            ...
            <span class="noc-count-los"><?php echo e($summary['los']); ?> LOS</span>
            <span class="noc-count-warning"><?php echo e($summary['low_rx']); ?> Low RX</span>
        </div>
        ...
        <table class="w-full text-left text-sm text-slate-600 dark:text-slate-300 whitespace-nowrap">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-700/60">
                ...
                <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-800/50 transition-colors noc-row-hover">
                    <td class="p-3 noc-mono noc-text font-medium"><?php echo e($onu->serial_number); ?></td>
                    <td class="p-3 noc-text-secondary"><?php echo e($onu->name ?? '-'); ?></td>
                    <td class="p-3 noc-muted">
                        <span class="noc-muted"><?php echo e($onu->olt->name ?? '-'); ?></span>
                        <span class="noc-muted opacity-60">/</span>
                        <span class="noc-mono noc-muted"><?php echo e($onu->ponPort->name ?? '-'); ?></span>
                    </td>
                    <td class="p-3 noc-muted"><?php echo e($onu->customerService->customer->name ?? '-'); ?></td>
                    <td class="p-3 noc-mono font-medium <?php echo e($rxClass); ?>"><?php echo e($onu->rx_power_dbm !== null ? number_format($onu->rx_power_dbm-1) . ' dBm' : '-'); ?></td>
                    <td class="p-3 noc-mono noc-muted"><?php echo e($onu->tx_power_dbm !== null ? number_format($onu->tx_power_dbm-1) . ' dBm' : '-'); ?></td>
                    <td class="p-3 noc-mono noc-muted"><?php echo e($onu->temperature ?? '-'); ?></td>
                    <td class="p-3">
                        <span class="px-1.5 py-0.5 rounded text-xs font-medium <?php echo e($badge); ?>"><?php echo e($st); ?></span>
                    </td>
                    <td class="p-3 noc-muted"><?php echo e($onu->last_seen_at ? $onu->last_seen_at->diffForHumans() : '-'); ?></td>
                    <td class="p-3">
                        <a href="<?php echo e(route('noc.onus.show', $onu->id)); ?>" class="text-blue-500 hover:text-blue-400">View</a>
                    </td>
                </tr>
