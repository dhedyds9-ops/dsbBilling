<div>
    ...
    <div class="no-print mb-4 flex justify-between items-center px-4 md:px-8">
        <a href="<?php echo e(route('billing.invoices.index')); ?>" class="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-50 dark:bg-slate-900/50 flex items-center gap-2 transition-colors">
...
</div><?php /**PATH D:\dsBilling\resources\views\livewire\billing\invoice\show.blade.php ENDPATH**/ ?>