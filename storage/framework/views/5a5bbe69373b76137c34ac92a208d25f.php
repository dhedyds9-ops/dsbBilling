<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-slate-100">Edit Quotation</h1>
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Edit informasi quotation</p>
        </div>
    </div>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\crm\quotation\edit.blade.php ENDPATH**/ ?>