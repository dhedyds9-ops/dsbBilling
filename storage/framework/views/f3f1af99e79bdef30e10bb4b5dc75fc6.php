...
<div class="space-y-5 pb-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('isp.pppoe-users.create')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg shadow-sm shadow-indigo-200 dark:shadow-none transition-all">
                        ...
                        <tr class="<?php echo e($rowBg); ?>">
                            ...
                            <td class="px-4 py-3 <?php echo e($textPrimary); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($user->customer->id)): ?>
                                    <a href="<?php echo e(route('crm.customers.show', $user->customer->id)); ?>" class="hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline transition-colors">
                            ...
                            <td class="px-4 py-3 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-1">
                                    <a href="<?php echo e(route('isp.pppoe-users.edit', $user->id)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-900/50 text-indigo-600 dark:text-indigo-400 transition-colors" title="Edit">
                                        <span class="material-symbols-outlined notranslate" translate="no" style="font-size:18px">edit</span>
                                    </a>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($user->customer->id)): ?>
                                        <a href="<?php echo e(route('crm.customers.show', $user->customer->id)); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-md bg-sky-50 hover:bg-sky-100 dark:bg-sky-900/30 dark:hover:bg-sky-900/50 text-sky-600 dark:text-sky-400 transition-colors" title="Portal Customer 360">
...
<?php /**PATH D:\dsBilling\resources\views\livewire\isp\pppoe-user\index.blade.php ENDPATH**/ ?>