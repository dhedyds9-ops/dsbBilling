...
<?php endif; ?>
    ...
    <div class="flex items-center gap-4 mb-3">
        <a href="<?php echo e(route('isp.odcs.index')); ?>" class="p-2 text-slate-500 hover:text-slate-700 rounded-lg hover:bg-slate-100">
        ...
        <div class="flex-1">
            <div class="flex items-center gap-3">
                <div class="w-14 h-14 rounded-full bg-primary-100 flex items-center justify-center text-primary-600 text-2xl font-bold">
                    <?php echo e(substr($odc->name, 0, 1)); ?>

                </div>
                <div>
                    <h1 class="text-2xl font-bold text-slate-900"><?php echo e($odc->name); ?></h1>
                    <div class="flex items-center gap-2 mt-1">
                        <span class="px-3 py-1 text-xs font-medium rounded-full 
                                    <?php if($odc->status === 'active'): ?> bg-green-100 text-green-600
                                    <?php else: ?> bg-slate-100 text-slate-600
                                    <?php endif; ?>">
                                    <?php echo e(ucfirst($odc->status)); ?>

                                </span>
                        <span class="text-sm text-slate-500 font-mono"><?php echo e($odc->code); ?></span>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('isp.odcs.edit', $odc->id)); ?>" class="px-4 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors">
                    Edit
                </a>
        </div>
    </div>
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4 pt-4 border-t border-slate-200">
                    <div class="p-4 bg-slate-50 rounded-lg">
                        ...
                        <p class="text-2xl font-bold text-slate-900"><?php echo e($odc->odps->count()); ?></p>
                    </div>
                </div>
            </div>
         <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\isp\odc\show.blade.php ENDPATH**/ ?>