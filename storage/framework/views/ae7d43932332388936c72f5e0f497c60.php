                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0">Rp <?php echo e(number_format($totalIncome, 0, ',', '.')); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0">Rp <?php echo e(number_format($totalCash, 0, ',', '.')); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\components\⚡dashboard.blade.php ENDPATH**/ ?>