            ...
            <div class="p-3 grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-3">
                    ...
                    <div class="space-y-1 max-h-96 overflow-auto">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $this->recentAlarms ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
    ...
    <?php elseif($this->activeTab === 'resources'): ?>
        <div class="flex-1 overflow-auto min-h-0">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700/60">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $this->resourcesData ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-700/40">
                            <td class="px-3 py-2 font-medium"><?php echo e($r['name']); ?></td>
                            <td class="px-3 py-2 font-mono text-xs text-slate-500 dark:text-slate-400"><?php echo e($r['host']); ?></td>
...
<?php endif; ?></td>
                            ...
                            <td class="px-3 py-2 text-xs text-slate-500 dark:text-slate-400"><?php echo e($r['uptime']); ?></td>
...
<?php endif; ?></td>
                            <td class="px-3 py-2 text-right">
                                <button wire:click="refreshRouter(<?php echo e($r['id']); ?>)" class="inline-flex items-center gap-1 px-2 py-1 text-xs rounded-md border border-slate-200 hover:bg-slate-50 dark:bg-slate-900/50 dark:border-slate-700 dark:hover:bg-slate-700">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $pageRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-700/40">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->activeTab === 'pppoe'): ?>
                                ...
                                <td class="px-3 py-2 text-xs text-slate-500 dark:text-slate-400"><?php echo e($r->session_started_at ? \Illuminate\Support\Carbon::parse($r->session_started_at)->diffForHumans() : '-'); ?></td>
                            <?php else: ?>
                                <td class="px-3 py-2 font-mono text-xs text-purple-600 dark:text-purple-400"><?php echo e($r->username); ?></td>
                                <td class="px-3 py-2 text-xs"><?php echo e($r->router?->name ?? '-'); ?></td>
                                <td class="px-3 py-2 font-mono text-xs"><?php echo e($r->ip_address); ?></td>
                                <td class="px-3 py-2 font-mono text-[10px] text-slate-500 dark:text-slate-400"><?php echo e($r->mac_address); ?></td>
                                <td class="px-3 py-2 text-right font-mono text-xs tabular-nums"><?php echo e($r->uptime); ?></td>
                                ...
                                <td class="px-3 py-2 text-right font-mono text-[10px] text-slate-500 dark:text-slate-400"><?php echo e($r->bytes_in ?? 0); ?> / <?php echo e($r->bytes_out ?? 0); ?></td>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <td class="px-3 py-2 text-right">
...
<?php /**PATH D:\dsBilling\resources\views\livewire\jaringan\monitoring\index.blade.php ENDPATH**/ ?>