        ...
        >
            <div class="flex items-start justify-between">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-900"><?php echo e($ticket['title'] ?? 'Unknown Ticket'); ?></p>
                        <p class="text-xs text-gray-500 mt-1"><?php echo e($ticket['id'] ?? ''); ?> - <?php echo e($ticket['customer_name'] ?? ''); ?></p>
                ...
                <div class="text-right">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($ticket['sla_deadline'])): ?>
                        ...
                        <p class="text-xs font-medium <?php echo e(($ticket['sla_breached'] ?? false) ? 'text-red-600' : 'text-gray-600'); ?>">
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\gis\components\ticket-panel.blade.php ENDPATH**/ ?>