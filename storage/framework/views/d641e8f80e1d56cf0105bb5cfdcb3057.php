<div class="space-y-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0 flex flex-wrap gap-2">
            ...
            <a href="<?php echo e(route('isp.ip-pools.create')); ?>" class="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors" </a>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-2 border-t border-slate-200 dark:border-slate-700">
                ...
                <div>
                    ...
                    <select wire:model.live="filters.pop_id" class="block w-full rounded-xl border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-sm py-2 px-3 focus:ring-primary-500 focus:border-blue-500 dark:bg-slate-900 dark:text-slate-100">
                        ...
                        <option value="<?php echo e($pop->id); ?>"><?php echo e($pop->name); ?></option>
        ...
        <div class="px-4 py-3 bg-blue-50 dark:bg-blue-900/30 border-b border-blue-100 dark:border-blue-800 flex flex-wrap items-center justify-between gap-3">
            <div class="text-sm text-primary-700 dark:text-blue-200 font-medium">
                <?php echo e(count($selectedIds)); ?> item terpilih
            </div>
            <div class="flex flex-wrap gap-2">
                ...
                <button wire:click="bulkDelete" wire:confirm="Yakin ingin menghapus <?php echo e(count($selectedIds)); ?> IP Pool terpilih?" class="inline-flex items-center px-3 py-1.5 border border-transparent rounded-lg text-xs font-medium text-white bg-red-600 hover:bg-red-700 transition-colors">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm text-slate-600 dark:text-slate-300">
                <thead class="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700">
                    <tr class="text-slate-500 dark:text-slate-400">
                        ...
                        <th scope="col" class="p-3 font-semibold cursor-pointer hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-200" wire:click="sortBy('name')">
                            Nama / Code
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'name'): ?> <span class="text-xs"><?php echo e($sortDirection === 'asc' ? '↑' : '↓'); ?></span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </th>
                        <th scope="col" class="p-3 font-semibold cursor-pointer hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-200" wire:click="sortBy('network')">
                            Network
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortField === 'network'): ?> <span class="text-xs"><?php echo e($sortDirection === 'asc' ? '↑' : '↓'); ?></span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </th>
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700/60">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ipPools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pool): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-700/50 transition-colors">
                        <td class="p-3">
                            <input type="checkbox" wire:model.live="selectedIds" value="<?php echo e((string)$pool->id); ?>" class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-slate-300 dark:border-slate-600 rounded">
                        </td>
                        <td class="p-3 whitespace-nowrap">
                            <div class="font-medium text-slate-900 dark:text-slate-100"><?php echo e($pool->name); ?></div>
                            <div class="text-xs text-slate-500 dark:text-slate-400 font-mono"><?php echo e($pool->code); ?></div>
                        </td>
                        <td class="p-3 whitespace-nowrap font-mono text-sm text-slate-700 dark:text-slate-200">
                            <?php echo e($pool->network ?? '-'); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pool->netmask): ?><span class="text-slate-500 dark:text-slate-400">/<?php echo e(long2ip(ip2long($pool->netmask)) ? substr_count(decbin(ip2long($pool->netmask)), '1') : '24'); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="p-3 whitespace-nowrap font-mono text-xs">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pool->start_ip && $pool->end_ip): ?>
                                <div class="text-slate-700 dark:text-slate-200"><?php echo e($pool->start_ip); ?></div>
                                <div class="text-slate-500 dark:text-slate-400">s/d <?php echo e($pool->end_ip); ?></div>
                            <?php else: ?>
                                <span class="text-slate-400">Group Only</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="p-3 whitespace-nowrap font-mono text-sm text-slate-700 dark:text-slate-200">
                            <?php echo e($pool->gateway ?? '-'); ?>

                        </td>
                        <td class="p-3 whitespace-nowrap text-sm">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pool->pop): ?>
                                <div class="text-slate-700 dark:text-slate-200 font-medium"><?php echo e(optional($pool->pop)->name); ?></div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(optional($pool->pop)->router): ?>
                                <div class="text-xs text-slate-500 dark:text-slate-400"><?php echo e(optional(optional($pool->pop)->router)->name); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
                        ...
                        <td class="p-3 whitespace-nowrap">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pool->total_ips > 0): ?>
                            <div class="flex items-center gap-2">
                                <div class="w-24 bg-slate-200 dark:bg-slate-700 rounded-full h-2 overflow-hidden">
                                    <div class="bg-blue-500 h-2 rounded-full" style="width: <?php echo e(min(100, round(($pool->used_ips / $pool->total_ips) * 100))); ?>%"></div>
                                </div>
                                <span class="text-xs font-medium text-slate-700 dark:text-slate-200"><?php echo e($pool->used_ips); ?>/<?php echo e($pool->total_ips); ?></span>
                            </div>
                            <?php else: ?>
...
<?php endif; ?>
                        ...
                        <td class="p-3 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end gap-1">
                                <a href="<?php echo e(route('isp.ip-pools.show', $pool- </a>
                                <button wire:click="toggleStatus({{ $pool->id); ?>)" class="<?php echo e($pool->status === 'active' ? 'text-amber-600 hover:text-amber-900 dark:text-amber-400 dark:hover:text-amber-200' : 'text-emerald-600 hover:text-emerald-900 dark:text-emerald-400 dark:hover:text-emerald-200'); ?> px-2 py-1 rounded-lg hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 transition-colors" title="<?php echo e($pool->status === 'active' ? 'Non Aktifkan' : 'Aktifkan'); ?>">
                    ...
                    <tr class="hover:bg-slate-50 dark:bg-slate-900/50 dark:hover:bg-slate-800/50 transition-colors">
                        <td colspan="9" class="p-8 text-center">
                            ...
                            <div class="mt-6 flex justify-center gap-2">
                                ...
                                <a href="<?php echo e(route('isp.ip-pools.create')); ?>" class="inline-flex items-center px-3 py-2 border border-transparent rounded-xl text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 transition-colors" </a>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\isp\ip-pool\index.blade.php ENDPATH**/ ?>