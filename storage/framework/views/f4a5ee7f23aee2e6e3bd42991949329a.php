    ...
    <div class="bg-[#111827] border border-[#00e5ff]/30 rounded-lg shadow-lg flex-1 flex flex-col overflow-hidden">
        ...
        <div class="px-4 py-3 border-b border-gray-800 flex justify-between items-center bg-[#0a0e1a]/50">
            <h5 class="text-[#00e5ff] font-bold m-0 flex items-center">
                <i class="bi bi-map mr-2"></i> <?php echo e(__('Peta Distribusi & Topologi')); ?>
        ...
        <div class="map-smart-toolbar">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($isAdmin) && $isAdmin): ?>
            <select id="areaFilter" class="toolbar-select dark:bg-slate-900 dark:text-slate-100">
                <option value=""><?php echo e(__('Semua Area')); ?></option>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $coordinators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($coord->region): ?>
                        <option value="<?php echo e($coord->region_id); ?>"><?php echo e($coord->region->name); ?> (<?php echo e($coord->name); ?>)</option>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen-sm-down">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="oltModalLabel"><?php echo e(__('Tempatkan OLT')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p><?php echo e(__('Pilih OLT untuk ditempatkan di peta:')); ?></p>
                <form id="oltForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100" id="olt_select" name="olt_id" required>
                            <option value=""><?php echo e(__('Pilih OLT')); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $olts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $olt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($olt->id); ?>" data-has-coord="<?php echo e($olt->latitude ? 'true' : 'false'); ?>">
                                    <?php echo e($olt->name); ?> (<?php echo e($olt->host); ?>) <?php echo e($olt->latitude ? '[Terkunci]' : ''); ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('Tutup')); ?></button>
                <button type="button" class="btn btn-primary" id="saveOltBtn"><?php echo e(__('Tempatkan OLT')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="odcModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="odcModalLabel"><?php echo e(__('Tambah ODC')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="odcForm">
                    ...
                    <div class="mb-3">
                        <label for="odc_name" class="form-label"><?php echo e(__('Nama ODC')); ?></label>
                        <input type="text" class="form-control dark:bg-slate-900 dark:text-slate-100" id="odc_name" name="name" required>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="odc_pon_port" class="form-label"><?php echo e(__('Port PON')); ?></label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="odc_area" class="form-label"><?php echo e(__('Area')); ?></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="odc_color" class="form-label"><?php echo e(__('Warna Tube / Fiber')); ?></label>
                            <select class="form-select dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100" id="odc_color" name="color" required>
                                <option value=""><?php echo e(__('Pilih Warna')); ?></option>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="odc_cable_no" class="form-label"><?php echo e(__('No Kabel')); ?></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="odc_lat" class="form-label"><?php echo e(__('Lintang')); ?></label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="odc_lng" class="form-label"><?php echo e(__('Bujur')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="odc_capacity" class="form-label"><?php echo e(__('Kapasitas')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="odc_olt" class="form-label"><?php echo e(__('OLT')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="odc_description" class="form-label"><?php echo e(__('Deskripsi')); ?></label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('Tutup')); ?></button>
                <button type="button" class="btn btn-primary" id="saveOdcBtn"><?php echo e(__('Simpan ODC')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="odpModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="odpModalLabel"><?php echo e(__('Tambah ODP')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="odpForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="odp_lng" class="form-label"><?php echo e(__('Bujur')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="odp_capacity" class="form-label"><?php echo e(__('Kapasitas')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="odp_region" class="form-label"><?php echo e(__('Wilayah')); ?></label>
                        <select class="form-select dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100" id="odp_region" name="region_id">
                            <option value=""><?php echo e(__('Pilih Wilayah')); ?></option>
                    ...
                    <div class="mb-3">
                        <label for="odp_odc" class="form-label"><?php echo e(__('Uplink ODC')); ?></label>
                        <select class="form-select dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100" id="odp_odc" name="odc_id">
                            <option value=""><?php echo e(__('Pilih ODC')); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $odcs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $odc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($odc->id); ?>"><?php echo e($odc->name); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="odp_color" class="form-label"><?php echo e(__('Warna Uplink')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="odp_description" class="form-label"><?php echo e(__('Deskripsi')); ?></label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('Tutup')); ?></button>
                <button type="button" class="btn btn-primary" id="saveOdpBtn"><?php echo e(__('Simpan ODP')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="htbModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="htbModalLabel"><?php echo e(__('Tambah HTB')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="htbForm">
                    ...
                    <div class="mb-3">
                        <label for="htb_name" class="form-label"><?php echo e(__('Nama HTB')); ?></label>
                        <input type="text" class="form-control dark:bg-slate-900 dark:text-slate-100" id="htb_name" name="name" required>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="htb_lat" class="form-label"><?php echo e(__('Lintang')); ?></label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="htb_lng" class="form-label"><?php echo e(__('Bujur')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="htb_uplink_type" class="form-label"><?php echo e(__('Tipe Uplink')); ?></label>
                    ...
                    <div class="mb-3" id="htb_odp_group">
                        <label for="htb_odp" class="form-label"><?php echo e(__('Uplink ODP')); ?></label>
                        <select class="form-select dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100" id="htb_odp" name="odp_id">
                            <option value=""><?php echo e(__('Pilih ODP')); ?></option>
                    ...
                    <div class="mb-3 d-none" id="htb_parent_group">
                        <label for="htb_parent" class="form-label"><?php echo e(__('Induk HTB')); ?></label>
                        <select class="form-select dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100" id="htb_parent" name="parent_htb_id">
                            <option value=""><?php echo e(__('Pilih Induk HTB')); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $htbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $htb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($htb->id); ?>"><?php echo e($htb->name); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="htb_description" class="form-label"><?php echo e(__('Deskripsi')); ?></label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('Tutup')); ?></button>
                <button type="button" class="btn btn-primary" id="saveHtbBtn"><?php echo e(__('Simpan HTB')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="closureModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen-sm-down">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="closureModalLabel"><?php echo e(__('Tambah Closure')); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="closureForm">
                    ...
                    <div class="mb-3">
                        <label for="closure_name" class="form-label"><?php echo e(__('Nama Closure')); ?></label>
                        <input type="text" class="form-control dark:bg-slate-900 dark:text-slate-100" id="closure_name" name="name" required>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="closure_lat" class="form-label"><?php echo e(__('Lintang')); ?></label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="closure_lng" class="form-label"><?php echo e(__('Bujur')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="closure_capacity" class="form-label"><?php echo e(__('Kapasitas')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="closure_region" class="form-label"><?php echo e(__('Wilayah')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="closure_odc" class="form-label"><?php echo e(__('Uplink ODC')); ?></label>
                    ...
                    <div class="mb-3">
                        <label for="closure_description" class="form-label"><?php echo e(__('Deskripsi')); ?></label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo e(__('Tutup')); ?></button>
                <button type="button" class="btn btn-primary" id="saveClosureBtn"><?php echo e(__('Simpan Closure')); ?></button>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var odps = <?php echo json_encode($odps, 15, 512) ?> || [];
        var htbs = <?php echo json_encode($htbs, 15, 512) ?> || [];
        var closures = <?php echo json_encode($closures, 15, 512) ?> || [];
        var odcs = <?php echo json_encode($odcs, 15, 512) ?> || [];
        var olts = <?php echo json_encode($olts, 15, 512) ?> || [];
        var assets = <?php echo json_encode($assets, 15, 512) ?> || [];
        var modemDataRecords = <?php echo json_encode($modemDataRecords ?? [], 15, 512) ?> || [];
        var coordinatorRegionId = <?php echo json_encode($coordinatorRegionId ?? null, 15, 512) ?>;
        var canManageMap = <?php echo json_encode($canManageMap ?? false, 15, 512) ?>;
        var canEditCustomer = <?php echo json_encode($canEditCustomer ?? false, 15, 512) ?>;
        ...
        */
        ...
        function saveConnectionByKey(key) {
            ...
            fetch('<?php echo e(route("map.connections.save")); ?>', {
                method: 'POST',
                headers: {
        ...
        function loadConnections() {
            fetch('<?php echo e(route("map.connections.index")); ?>')
            .then(res => res.json())
            .then(data => {
                data.forEach(conn => {
                    // Reconstruct key
        ...
        fetch('<?php echo e(route("api.network.online-paths")); ?>')
        ...
        function updateLocation(type, id, lat, lng, oldLat, oldLng, marker) {
            if (!confirm('<?php echo e(__('Perbarui lokasi ke koordinat baru?')); ?>')) {
            ...
            .then(result => {
                if (result.success || result.id) {
                    ...
                    alert('<?php echo e(__('Lokasi berhasil diperbarui!')); ?>');
                } else {
                    var msg = result.message || JSON.stringify(result);
                    if (result.errors) {
                        msg += '\n' + JSON.stringify(result.errors);
                    }
                    alert('<?php echo e(__('Gagal memperbarui lokasi:')); ?> ' + msg);
                    marker.setLatLng([oldLat, oldLng]);
                    drawLines();
                }
            })
            .catch(error => {
                console.error('Error:', error);
                alert('<?php echo e(__('Gagal memperbarui lokasi:')); ?> ' + error.message);
                marker.setLatLng([oldLat, oldLng]);
                drawLines();
            });
        }
        ...
        olts.forEach(function(olt) {
            if (olt.latitude && olt.longitude) {
                ...
                editLink.innerText = '<?php echo e(__('Edit OLT')); ?>';
        ...
        odcs.forEach(function(odc) {
            if (odc.latitude && odc.longitude) {
                ...
                editBtn.innerText = '<?php echo e(__('Edit ODC')); ?>';
        ...
        odps.forEach(function(odp) {
            if (odp.latitude && odp.longitude) {
                ...
                var editBtn = document.createElement('button');
                editBtn.className = 'btn btn-sm btn-outline-primary map-popup-btn';
                editBtn.innerText = '<?php echo e(__('Edit ODP')); ?>';
        ...
        htbs.forEach(function(htb) {
            if (htb.latitude && htb.longitude) {
                ...
                var editBtn = document.createElement('button');
                editBtn.className = 'btn btn-sm btn-outline-primary map-popup-btn';
                editBtn.innerText = '<?php echo e(__('Edit HTB')); ?>';
        ...
        closures.forEach(function(closure) {
            if (closure.latitude && closure.longitude) {
                ...
                var editBtn = document.createElement('button');
                editBtn.className = 'btn btn-sm btn-outline-primary map-popup-btn';
                editBtn.innerText = '<?php echo e(__('Edit Closure')); ?>';
        ...
        assets.forEach(function(asset) {
            if (asset.latitude && asset.longitude) {
                ...
                editLink.className = 'btn btn-sm btn-outline-primary map-popup-btn';
                editLink.innerText = '<?php echo e(__('Edit Aset')); ?>';
        ...
        */
        ...
        map.on('click', function(e) {
            ...
            if (addMode === 'olt') {
                ...
                document.getElementById('odcModalLabel').innerText = '<?php echo e(__('Tambah ODC')); ?>'; // Set title
                ...
                document.getElementById('odpModalLabel').innerText = '<?php echo e(__('Tambah ODP')); ?>'; // Set title
                ...
                document.getElementById('htbModalLabel').innerText = '<?php echo e(__('Tambah HTB')); ?>';
                ...
                document.getElementById('closureModalLabel').innerText = '<?php echo e(__('Tambah Closure')); ?>';
        ...
        window.editOdc = function(id) {
            ...
            if (odc) {
                ...
                document.getElementById('odcModalLabel').innerText = '<?php echo e(__('Edit ODC')); ?>';
                var odcModal = new bootstrap.Modal(document.getElementById('odcModal'));
                odcModal.show();
            }
        };
        ...
        window.editOdp = function(id) {
            ...
            if (odp) {
                ...
                document.getElementById('odpModalLabel').innerText = '<?php echo e(__('Edit ODP')); ?>';
                var odpModal = new bootstrap.Modal(document.getElementById('odpModal'));
                odpModal.show();
            }
        };
        ...
        window.editHtb = function(id) {
            ...
            if (htb) {
                ...
                document.getElementById('htbModalLabel').innerText = '<?php echo e(__('Edit HTB')); ?>';
                var htbModal = new bootstrap.Modal(document.getElementById('htbModal'));
                htbModal.show();
            }
        };
        ...
        window.editClosure = function(id) {
            ...
            if (closure) {
                ...
                document.getElementById('closureModalLabel').innerText = '<?php echo e(__('Edit Closure')); ?>';
                var closureModal = new bootstrap.Modal(document.getElementById('closureModal'));
                closureModal.show();
            }
        };
        ...
        document.getElementById('saveOltBtn').addEventListener('click', function() {
            ...
            if (!id) {
                alert('<?php echo e(__('Please select an OLT')); ?>');
                return;
            }
            ...
            if (!item) {
                 alert('<?php echo e(__('OLT not found')); ?>');
                 return;
            }
            ...
            .then(data => {
                if (data.success || data.id) {
                    ...
                    alert('<?php echo e(__('Error placing OLT:')); ?> ' + (data.message || JSON.stringify(data)));
                }
            })
            .catch(error => {
                console.error('Error:', error);
                alert('<?php echo e(__('An error occurred while saving.')); ?>');
            });
        });
        ...
        document.getElementById('saveClosureBtn').addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success || data.id) {
                    ...
                    alert('<?php echo e(__('Error saving Closure:')); ?> ' + (data.message || JSON.stringify(data)));
                }
            })
            .catch(error => {
                console.error('Error:', error);
                ...
                alert('<?php echo e(__('An error occurred while saving:')); ?> ' + errorMsg);
            });
        });
        ...
        document.getElementById('saveOdcBtn').addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success || data.id) { // Some controllers return full object
                    ...
                    alert('<?php echo e(__('Error saving ODC:')); ?> ' + (data.message || JSON.stringify(data)));
                }
            })
            .catch(error => {
                console.error('Error:', error);
        ...
        document.getElementById('saveOdpBtn').addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success || data.id) {
                    ...
                    alert('<?php echo e(__('Error saving ODP:')); ?> ' + (data.message || JSON.stringify(data)));
                }
            })
            .catch(error => {
                console.error('Error:', error);
        ...
        document.getElementById('saveHtbBtn').addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success || data.id) {
                    ...
                    alert('<?php echo e(__('Error saving HTB:')); ?> ' + (data.message || JSON.stringify(data)));
                }
            })
            .catch(error => {
                console.error('Error:', error);
...
<?php /**PATH D:\dsBilling\resources\views\livewire\gis\components\map.blade.php ENDPATH**/ ?>