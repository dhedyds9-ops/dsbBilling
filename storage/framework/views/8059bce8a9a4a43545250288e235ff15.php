    ...
    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div class="mt-3 flex flex-wrap gap-2">
            <button 
                ...
                class="px-3 py-1 text-xs font-medium rounded-full <?php echo e($searchType === 'all' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
            >
                All
            </button>
            <button 
                wire:click="$set('searchType', 'olt')"
                class="px-3 py-1 text-xs font-medium rounded-full <?php echo e($searchType === 'olt' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
            >
                OLT
            </button>
            <button 
                wire:click="$set('searchType', 'odp')"
                class="px-3 py-1 text-xs font-medium rounded-full <?php echo e($searchType === 'odp' ? 'bg-green-100 text-green-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
            >
                ODP
            </button>
            <button 
                wire:click="$set('searchType', 'customer')"
                class="px-3 py-1 text-xs font-medium rounded-full <?php echo e($searchType === 'customer' ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
            >
                Customer
            </button>
            <button 
                wire:click="$set('searchType', 'ticket')"
                class="px-3 py-1 text-xs font-medium rounded-full <?php echo e($searchType === 'ticket' ? 'bg-amber-100 text-amber-700' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200'); ?>"
            >
                Ticket
            </button>
        </div>
                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($result['name']); ?></p>
                                <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($result['location']); ?></p>
                            </div>
                        </div>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\gis\components\search-panel.blade.php ENDPATH**/ ?>