...
<div class="space-y-1.5" <?php echo e($attributes->only(['wire:model', 'wire:model.lazy', 'x-model'])); ?>>
    ...
    <div class="relative">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasIcon && $iconPosition === 'left'): ?>
...
<?php endif; ?>
        ...
        <input
            ...
            <?php echo e($attributes->except(['required'])->merge(['class' => $classes . ' ' . $inputPadding])); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasIcon && $iconPosition === 'right'): ?>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\components\forms\input.blade.php ENDPATH**/ ?>