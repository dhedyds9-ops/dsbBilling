          ...
          <tr class="hover:bg-slate-50 dark:hover:bg-slate-900/40 transition-colors">
            ...
            <td class="px-3 py-2 text-slate-700 dark:text-slate-200">
              ...
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phone): ?>
                <div class="text-xs text-slate-400 dark:text-slate-500"><?php echo e($phone); ?></div>
              <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </td>
            <td class="px-3 py-2 text-slate-700 dark:text-slate-200">
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\pelanggan\isolir\index.blade.php ENDPATH**/ ?>