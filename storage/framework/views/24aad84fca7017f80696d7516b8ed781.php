            ...
            <div class="col-md-6">
                <form method="GET" class="d-flex gap-2">
                    <div class="form-group flex-grow-1">
                        ...
                        <input type="month" name="period" id="period" class="form-control dark:bg-slate-900 dark:text-slate-100" value="<?php echo e($period); ?>">
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dsBilling\resources\views\revenue-sharing\index.blade.php ENDPATH**/ ?>