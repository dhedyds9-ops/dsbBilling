<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    ...
    <div class="flex border-b border-gray-200">
        <button 
            ...
            class="flex-1 px-4 py-2 text-sm font-medium <?php echo e($activeTab === 'overview' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'); ?>"
        >
            Overview
        </button>
        <button 
            wire:click="$set('activeTab', 'performance')"
            class="flex-1 px-4 py-2 text-sm font-medium <?php echo e($activeTab === 'performance' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'); ?>"
        >
            Performance
        </button>
        <button 
            wire:click="$set('activeTab', 'connections')"
            class="flex-1 px-4 py-2 text-sm font-medium <?php echo e($activeTab === 'connections' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'); ?>"
        >
            Connections
        </button>
    </div>
            ...
            case ('overview'): ?>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs text-gray-500">ID: <?php echo e($nodeId); ?></span>
                    </div>

                    <div>
                        <h4 class="text-lg font-semibold text-gray-900"><?php echo e($nodeData['name'] ?? 'Unknown Node'); ?></h4>
                        <p class="text-sm text-gray-500"><?php echo e($nodeData['location'] ?? 'No location'); ?></p>
                    </div>
            ...
            <?php case ('performance'): ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-gray-200 rounded-lg p-3">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-700"><?php echo e($metric['label'] ?? 'Metric'); ?></span>
                ...
                <div class="space-y-3">
                    ...
                    >
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900"><?php echo e($related['name'] ?? 'Unknown'); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($related['connection_type'] ?? 'Connected'); ?></p>
                            </div>
                        </div>
