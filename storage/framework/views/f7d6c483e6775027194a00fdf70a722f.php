...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.page-header','data' => ['title' => 'Manajemen Cabang / Area','subtitle' => 'Kelola cabang dan area operasional ISP Anda']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Manajemen Cabang / Area','subtitle' => 'Kelola cabang dan area operasional ISP Anda']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

         <?php $__env->slot('actions', null, []); ?> 
            <?php if (isset($component)) { $__componentOriginale00eb601fbe667f0da582732d70c41c5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale00eb601fbe667f0da582732d70c41c5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.button','data' => ['wire:click' => 'openCreate','variant' => 'primary','class' => 'flex items-center gap-2 shadow-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'openCreate','variant' => 'primary','class' => 'flex items-center gap-2 shadow-sm']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 flex items-center gap-4 shadow-sm">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-800 dark:text-slate-200"><?php echo e($stats['total']); ?></p>
                </div>
            </div>
            <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 flex items-center gap-4 shadow-sm">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-emerald-600"><?php echo e($stats['active']); ?></p>
                </div>
            </div>
            <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 flex items-center gap-4 shadow-sm">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-slate-500 dark:text-slate-400"><?php echo e($stats['inactive']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
            ...
            <div class="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div class="relative">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'search','class' => 'absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'search','class' => 'absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
<?php echo e($branch->code); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <td class="p-3">
                                    <div class="font-semibold text-slate-800 dark:text-slate-200"><?php echo e($branch->name); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($branch->address): ?>
                                        <div class="text-xs text-slate-400 mt-0.5 truncate max-w-[200px]"><?php echo e($branch->address); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="p-3  text-slate-600 dark:text-slate-400">
                                    <?php echo e($branch->city ?? '-'); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($branch->province): ?>
                                        <span class="text-slate-400">- <?php echo e($branch->province); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="p-3  text-slate-600 dark:text-slate-400">
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($branch->email): ?>
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$branch->phone && !$branch->email): ?> <span class="text-slate-300">—</span> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="p-3  text-center">
                                    <span class="text-slate-700 dark:text-slate-300 font-semibold"><?php echo e($branch->customers_count); ?></span>
                                    <span class="text-slate-400 text-xs"> pelanggan</span>
                                </td>
                                <td class="p-3  text-center">
                                    <button wire:click="toggleActive(<?php echo e($branch->id); ?>)" class="cursor-pointer">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($branch->is_active): ?>
                                            <?php if (isset($component)) { $__componentOriginalab7baa01105b3dfe1e0cf1dfc58879b4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalab7baa01105b3dfe1e0cf1dfc58879b4 = $attributes; } ?>
...
<?php endif; ?>
                                ...
                                <td class="p-3">
                                    <div class="flex items-center justify-end gap-2">
                                        <button wire:click="openEdit(<?php echo e($branch->id); ?>)" 
                                            class="p-1.5 text-primary-500 hover:bg-primary-50 rounded-md transition-colors" title="Edit">
                                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'pencil','class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                        ...
                                        <button wire:click="delete(<?php echo e($branch->id); ?>)"
                                            wire:confirm="Yakin ingin menghapus cabang '<?php echo e($branch->name); ?>'-"
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($branches->hasPages()): ?>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-xl flex flex-col max-h-[92vh]">
            ...
            <div class="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex items-center justify-between">
                <h3 class="text-lg font-bold text-slate-800 dark:text-slate-200">
                    <?php echo e($isEditing ?'Edit Cabang' : 'Tambah Cabang Baru'); ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" wire:model="form_code" placeholder="CBG-01"
                                    class="w-full rounded-lg border-slate-300 dark:border-slate-600 shadow-sm text-sm focus:border-primary-500 focus:ring-primary-500 uppercase <?php $__errorArgs = ['form_code'];
...
unset($__errorArgs, $__bag); ?> dark:bg-slate-900 dark:text-slate-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" wire:model="form_name" placeholder="Cabang Sukabumi"
                                    class="w-full rounded-lg border-slate-300 dark:border-slate-600 shadow-sm text-sm focus:border-primary-500 focus:ring-primary-500 <?php $__errorArgs = ['form_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> dark:bg-slate-900 dark:text-slate-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-red-500"><?php echo e($message); ?></p> <?php unset($message);
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="email" wire:model="form_email" placeholder="cabang@isp.id"
                                    class="w-full rounded-lg border-slate-300 dark:border-slate-600 shadow-sm text-sm focus:border-primary-500 focus:ring-primary-500 <?php $__errorArgs = ['form_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> dark:bg-slate-900 dark:text-slate-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['form_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-red-500"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="flex items-center gap-3 pt-1">
                            <button type="button" wire:click="$toggle('form_is_active')"
                                class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors <?php echo e($form_is_active ?'bg-emerald-500' : 'bg-slate-300'); ?>">
                                <span class="inline-block h-4 w-4 transform rounded-full bg-white dark:bg-slate-800 shadow transition-transform <?php echo e($form_is_active ?'translate-x-6' : 'translate-x-1'); ?>"></span>
                            </button>
                            <label class="text-sm font-medium text-slate-700 dark:text-slate-300">
                                <?php echo e($form_is_active ?'Cabang Aktif' : 'Cabang Nonaktif'); ?>
            ...
            <div class="px-6 py-4 border-t border-slate-100 dark:border-slate-700 flex justify-end gap-3">
                ...
                <button type="submit" form="branchForm" wire:loading.attr="disabled"
                    ...
                    <?php echo e($isEditing ?'Simpan Perubahan' : 'Tambah Cabang'); ?>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\admin\branch\index.blade.php ENDPATH**/ ?>