    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                Preview: <?php echo e($template->name); ?>

            </h2>
            <div class="flex space-x-2">
                <a href="<?php echo e(route('isp.voucher-templates.edit', $template->id)); ?>" class="inline-flex items-center px-4 py-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-gray-600 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest hover:bg-gray-50 dark:bg-gray-900/50">
                    Kembali ke Editor
                </a>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 print:max-w-none print:px-0">
            ...
            <div class="bg-white dark:bg-slate-800 p-4 mb-6 rounded-lg shadow print:hidden flex flex-wrap gap-4 items-center">
                <div class="flex items-center space-x-2">
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Jumlah Batch:</label>
                    <select wire:model.live="batchCount" class="border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm py-1 dark:bg-slate-900 dark:text-slate-100">
                ...
                <div class="flex items-center space-x-2 ml-4">
                    <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Test Harga (Conditional):</label>
                    <select wire:model.live="selectedPrice" class="border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm py-1 dark:bg-slate-900 dark:text-slate-100">
...
<?php /**PATH D:\dsBilling\resources\views\livewire\i-s-p\voucher-template\preview.blade.php ENDPATH**/ ?>