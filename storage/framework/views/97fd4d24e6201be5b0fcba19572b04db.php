        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('customer.login')); ?>" class="text-blue-600 hover:text-blue-800 font-medium transition">Login Pelanggan</a>
                    <a href="<?php echo e(route('admin.login')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition font-medium">Login Admin</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="<?php echo e(route('customer.login')); ?>" class="border-2 border-white text-white px-8 py-3 rounded-xl font-semibold text-lg hover:bg-white hover:text-blue-600 transition text-center">Login Pelanggan</a>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-blue-200 transition">
                    ...
                    <a href="<?php echo e(route('customer.login')); ?>" class="block w-full text-center border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-blue-50 transition">Pilih Paket</a>
                </div>
                <div class="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white transform md:scale-105 shadow-xl">
                    ...
                    <a href="<?php echo e(route('customer.login')); ?>" class="block w-full text-center bg-white text-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition">Pilih Paket</a>
                </div>
                <div class="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-blue-200 transition">
    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> dsBilling. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
</html>
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\landing.blade.php ENDPATH**/ ?>