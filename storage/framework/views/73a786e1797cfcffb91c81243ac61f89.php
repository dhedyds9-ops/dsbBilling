...
<div class="border-b border-slate-200 dark:border-slate-700" <?php echo e($attributes); ?>>
    <button
        type="button"
...
<?php endif; ?>
            ...
            <span class="font-medium text-slate-900 dark:text-slate-100"><?php echo e($title); ?></span>
        </div>
...
<?php /**PATH D:\dsBilling\resources\views\components\layout\accordion-item.blade.php ENDPATH**/ ?>