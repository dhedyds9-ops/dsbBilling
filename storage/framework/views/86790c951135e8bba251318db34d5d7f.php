                ...
                <thead class="bg-slate-100 dark:bg-slate-800 sticky top-0 z-10">
                    <tr class="text-slate-600 dark:text-slate-300 text-xs uppercase tracking-wide">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->activeTab === 'olt'): ?>
                            <th class="px-3 py-2 text-left cursor-pointer hover:text-slate-900" wire:click="sortBy('id')">ID <?php if (isset($component)) { $__componentOriginal80626b412c9489d98de013c8202fdf83 = $component; } ?>
...
<?php endif; ?></th>
                            <th class="px-3 py-2 text-left cursor-pointer hover:text-slate-900" wire:click="sortBy('name')">Nama <?php if (isset($component)) { $__componentOriginal80626b412c9489d98de013c8202fdf83 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal80626b412c9489d98de013c8202fdf83 = $attributes; } ?>
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700/60">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pageRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/60">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->activeTab === 'olt'): ?>
                                <td class="px-3 py-2 font-mono text-xs text-slate-500"><?php echo e($r->id); ?></td>
...
<?php endif; ?></td>
                                ...
                                <td class="px-3 py-2 text-xs text-slate-500"><?php echo e($r->last_registered_at ? \Illuminate\Support\Carbon::parse($r->last_registered_at)->diffForHumans() : '-'); ?></td>
                            <?php elseif($this->activeTab === 'odp'): ?>
                                <td class="px-3 py-2 font-medium"><?php echo e($r->name); ?></td>
                                <td class="px-3 py-2 text-xs text-slate-500"><?php echo e($r->location ?? '-'); ?></td>
                                <td class="px-3 py-2"><?php echo e($r->pop->name ?? '-'); ?></td>
                                <td class="px-3 py-2"><?php echo e($r->olt->name ?? '-'); ?></td>
                            ...
                            <?php elseif($this->activeTab === 'pop'): ?>
                                <td class="px-3 py-2 font-medium"><?php echo e($r->name); ?></td>
                                <td class="px-3 py-2 text-xs text-slate-500 max-w-xs truncate"><?php echo e($r->address); ?></td>
...
<?php endif; ?></td>
                            ...
                            <td class="px-3 py-2 text-right whitespace-nowrap">
                                <div class="inline-flex items-center gap-0.5">
                                    <button wire:click="rowEdit(<?php echo e($r->id); ?>)" class="p-1 text-slate-500 hover:text-blue-600 hover:bg-blue-50 rounded dark:hover:bg-blue-900/30" title="Edit">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
                                    </button>
                                    <button wire:click="rowDetail(<?php echo e($r->id); ?>)" class="p-1 text-slate-500 hover:text-blue-600 hover:bg-blue-50 rounded dark:hover:bg-blue-900/30" title="Detail">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                    </button>
                                    <button wire:click="rowSync(<?php echo e($r->id); ?>)" class="p-1 text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 rounded dark:hover:bg-emerald-900/30" title="Sync">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                                    </button>
                                    <button wire:click="rowShowMap(<?php echo e($r->id); ?>)" class="p-1 text-slate-500 hover:text-cyan-600 hover:bg-cyan-50 rounded dark:hover:bg-cyan-900/30" title="Map">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->activeTab === 'onu'): ?>
                                        <button wire:click="rowTestLos(<?php echo e($r->id); ?>)" class="p-1 text-slate-500 hover:text-red-600 hover:bg-red-50 rounded dark:hover:bg-red-900/30" title="Test LOS">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($r->status ?? '') === 'active'): ?>
                                        <button wire:click="rowDisable(<?php echo e($r->id); ?>)" class="p-1 text-amber-600 hover:text-amber-700 hover:bg-amber-50 rounded dark:hover:bg-amber-900/30" title="Disable">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"/></svg>
                                        </button>
                                    <?php else: ?>
                                        <button wire:click="rowEnable(<?php echo e($r->id); ?>)" class="p-1 text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded dark:hover:bg-emerald-900/30" title="Enable">
        ...
        <div x-data="{ show: true }" x-show="show" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
            <div x-show="show" class="w-full max-w-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-2xl">
                ...
                <div class="px-5 py-4 space-y-2 text-sm">
                    <div class="flex justify-between"><span class="text-slate-500">SN:</span><span class="font-mono"><?php echo e($this->losTestResult['serial_number']); ?></span></div>
                    <div class="flex justify-between"><span class="text-slate-500">Status:</span><?php if (isset($component)) { $__componentOriginal8c81617a70e11bcf247c4db924ab1b62 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8c81617a70e11bcf247c4db924ab1b62 = $attributes; } ?>
...
<?php unset($__componentOriginal8c81617a70e11bcf247c4db924ab1b62); ?>
<?php endif; ?></div>
                    <div class="flex justify-between"><span class="text-slate-500">RX Power:</span><span class="font-mono"><?php echo e($this->losTestResult['rx_power_dbm'] ?? '-'); ?> dBm</span></div>
                    <div class="flex justify-between"><span class="text-slate-500">TX Power:</span><span class="font-mono"><?php echo e($this->losTestResult['tx_power_dbm'] ?? '-'); ?> dBm</span></div>
                    <div class="flex justify-between"><span class="text-slate-500">Diuji:</span><span class="text-xs"><?php echo e($this->losTestResult['tested_at']); ?></span></div>
                </div>
    ...
    <?php if (! $__env->hasRenderedOnce('2442ba95-c023-4b0b-82ee-913e5a59135c')): $__env->markAsRenderedOnce('2442ba95-c023-4b0b-82ee-913e5a59135c'); ?>
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\jaringan\fiber\index.blade.php ENDPATH**/ ?>