...
<div class="relative inline-block" <?php echo e($attributes); ?>>
    ...
    <?php else: ?>
        <div class="<?php echo e($avatarClasses); ?> <?php echo e($roundedClass); ?> bg-slate-200 flex items-center justify-center text-slate-500 ring-2 ring-white">
...
<?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views/components/display/avatar.blade.php ENDPATH**/ ?>