<?php $__env->startSection('page_title'); ?>
    <a href="<?php echo e(route('isp.olts.index')); ?>" class="p-1.5 mr-2 text-indigo-100 hover:text-white rounded-lg hover:bg-indigo-700/50 transition-colors" title="Kembali">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detectedInfo): ?>
            <div class="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 rounded-lg p-4 mb-4">
                ...
                <ul class="text-sm text-blue-700 space-y-1">
                    <li><strong>Model:</strong> <?php echo e($detectedInfo['model'] ?? '-'); ?></li>
                    <li><strong>Firmware:</strong> <?php echo e($detectedInfo['firmware'] ?? '-'); ?></li>
                    <li><strong>Hardware:</strong> <?php echo e($detectedInfo['hardware_version'] ?? '-'); ?></li>
                    <li><strong>MAC:</strong> <?php echo e($detectedInfo['mac_address'] ?? '-'); ?></li>
                    <li><strong>SN:</strong> <?php echo e($detectedInfo['serial_number'] ?? '-'); ?></li>
                    <li><strong>Uptime:</strong> <?php echo e($detectedInfo['uptime'] ?? '-'); ?></li>
                </ul>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <div class="flex items-center justify-end gap-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                <a href="<?php echo e(route('isp.olts.show', $olt->id)); ?>" class="px-6 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium hover:bg-slate-50 dark:bg-slate-900/50 transition-colors">
                    Batal
                </a>
...
<?php /**PATH D:\dsBilling\resources\views\livewire\isp\olt\edit.blade.php ENDPATH**/ ?>