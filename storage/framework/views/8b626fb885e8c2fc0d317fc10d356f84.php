<div class="space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">Buat user baru</p>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex items-center justify-end gap-4 pt-4 border-t border-slate-200">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="px-6 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors">
                    Batal
                </a>
...
</div><?php /**PATH C:\Users\Lenovo\OneDrive\dsBilling\resources\views\livewire\admin\user\create.blade.php ENDPATH**/ ?>