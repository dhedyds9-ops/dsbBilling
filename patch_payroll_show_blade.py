...
with open(file_blade, 'w', encoding='utf-8') as f:
    f.write("""<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg print:shadow-none print:rounded-none">
        <div class="p-8 print:p-0 text-slate-800">
            <!-- Header Perusahaan -->
            <div class="flex justify-between items-start border-b-2 border-slate-800 pb-4 mb-6 print:border-black">
                ...
                <div class="text-right">
                    ...
                    <p class="text-[13px] sm:text-sm font-semibold text-slate-700 print:text-black mt-1">Periode: {{ \\Carbon\\Carbon::createFromDate($payroll->period_year, $payroll->period_month, 1)->translatedFormat('F Y') }}</p>
                    <p class="text-xs text-slate-500 print:text-slate-700 mt-0.5">Dicetak: {{ now()->translatedFormat('d M Y H:i') }}</p>
                </div>
            </div>

            <!-- Detail Karyawan -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 text-[13px] sm:text-sm print:grid-cols-2 print:text-black">
                <div>
                    <table class="w-full">
                        <tr><td class="py-1 text-slate-500 print:text-slate-800 w-32 font-medium">Nama Karyawan</td><td class="py-1 font-bold text-slate-900 print:text-black">: {{ $payroll->employee->name ?? '-' }}</td></tr>
                ...
                <div>
                    <table class="w-full">
                        <tr><td class="py-1 text-slate-500 print:text-slate-800 w-32 font-medium">Departemen</td><td class="py-1 font-semibold text-slate-800 print:text-black">: {{ $payroll->employee->department ?? '-' }}</td></tr>
            ...
            <!-- Rincian Gaji -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8 print:grid-cols-2">
                <!-- Pendapatan -->
                <div>
            ...
            <!-- Total -->
            <div class="bg-slate-50 border border-slate-200 rounded-lg p-5 mb-8 flex flex-col sm:flex-row justify-between sm:items-center print:bg-transparent print:border-t-2 print:border-b-2 print:border-l-0 print:border-r-0 print:border-black print:rounded-none">
            ...
            <!-- Notes & Signatures -->
            <div class="flex flex-col sm:flex-row justify-between mt-12 text-[13px] sm:text-sm print:flex-row print:text-black">
                <div class="w-full sm:w-1/3 mb-8 sm:mb-0 print:mb-0">
                ...
                <div class="flex w-full sm:w-2/3 justify-around print:w-2/3">
...
""")
print("Admin Payroll Show blade updated")
